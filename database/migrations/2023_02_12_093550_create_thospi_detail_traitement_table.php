...
class CreateThospiDetailTraitementTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('thospi_detail_traitement', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('thospi_detail_traitement');
    }
}
