...
class CreateTimScoreProbabiliteScoreTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tim_score_probabilite_score', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tim_score_probabilite_score');
    }
}
