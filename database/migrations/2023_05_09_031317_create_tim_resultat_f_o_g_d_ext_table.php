...
class CreateTimResultatFOGDExtTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tim_resultat_f_o_g_d_ext', function (Blueprint $table) {
            $table->id();
            $table->foreignId('refImagerie')->constrained('tim_imagerie_ext')->restrictOnUpdate()->restrictOnDelete();
            $table->date('dateResultat',100);
    ...
    {
        Schema::dropIfExists('tim_resultat_f_o_g_d_ext');
    }
}
