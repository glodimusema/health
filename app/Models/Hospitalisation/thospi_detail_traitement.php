...
class thospi_detail_traitement extends Model
{
    protected $fillable=['id','refTraitem','refMedicament','posologie','vait','fait08h','qte08h',
    ...
    protected $table = 'thospi_detail_traitement';
}
