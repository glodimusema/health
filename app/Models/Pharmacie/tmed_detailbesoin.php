...
class tmed_detailbesoin extends Model
{
    protected $fillable=['id','refEnteteVente','refmedicament','qte_besoin','pu_besoin','observation_besoin','author'];
    protected $table = 'tmed_detailbesoin';
