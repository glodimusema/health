...
class UserController extends Controller
{
    ...
    // function insert_userss(Request $request)
    // {
    ...
    // function update_userss(Request $request, $id)
    // {
    ...
    function showUtilisateurDetailPrint($id)
    {
        $data = DB::table('users')
        ->join('roles','users.id_role','=','roles.id')
        ->select('users.id as user_id','users.avatar','users.name','users.email','users.id_role','roles.nom as role_name','users.sexe','users.telephone','users.adresse','users.active')
            ...
            $output.=' 
                <tr>
                    ...
                    <td colspan="1"> 
                        ...
                        N° de Téléphon:<a href="tel:'.$row->telephone.'">'.$row->telephone.'</a>
    ...
    function convertHtmlTug($id)
    {
        ...
        ';
        //$output .=''+ $this->showUtilisateurDetailPrint($id);
        return $output;
