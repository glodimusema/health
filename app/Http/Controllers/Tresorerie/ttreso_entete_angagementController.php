    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            $data = ttreso_entete_angagement::create([
                ...
                'StatutValiderDivision' =>  'NON',
                'ValiderDivision' =>  'Encours',
                'dateAtesterDivision' =>  date('Y-m-d'),
                'StatutAtesterDivision' =>  'NON',
                'Atesterterdivision' =>  'Encours',
                'dateValiderTresorerie' =>  date('Y-m-d'),
                'ValiderStatuttresorerie' =>  'NON',
                'ValiderTresorerie' =>  'Encours',
                'dateAtesterTresorerie' =>  date('Y-m-d'),
                'StatutAtesterTresorerie' =>  'NON',
                'AtesterterTresorier' =>  'Encours',
                'dateValiderAdministration' =>  date('Y-m-d'),
                'ValiderStatutAdministration' =>  'NON',
                'ValiderAdministrateur' =>  'Encours',
                'dateAtesterAdministration' =>  date('Y-m-d'),
                'StatutAtesterAdministration' =>  'NON',
                'AtesterterAdministrateur' =>  'Encours',
                'dateValiderDirection' =>  date('Y-m-d'),
                'ValiderStatutDirection' =>  'NON',
                'ValiderDirecteur' =>  'Encours',
                'dateAtesterDirection' =>  date('Y-m-d'),
                'StatutAtesterDirection' =>  'NON',
                'AtesterterDirecteur' =>  'Encours',
                'dateValidertGerant' =>  date('Y-m-d'),
                'ValiderStatutGerant' =>  'NON',
                'ValiderGerant' =>  'Encours',
                'dateAtesterGerant' =>  date('Y-m-d'),
                'StatutAtesterGerant' =>  'NON',
                'AtesterterGerant' =>  'Encours',
