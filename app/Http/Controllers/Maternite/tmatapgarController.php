...
use App\Models\Maternite\tmatapgar;
use App\Traits\JsonResponseTrait; 
use App\Traits\{GlobalMethod,Slug};
use DB;

class tmatapgarController extends Controller
{
    ...
    { 
        ...
        if (!is_null($request->get('query'))) 
        {
            ...
            $data = DB::table('tmatapgar')
            ->join('tmat_partogramme','tmat_partogramme.id','=','tmatapgar.refpatogramme')
            ...
            ->select("tmatapgar.id","respiration","Fc_Apgar","refexes","toms_musculaire",
            "refexes","coloration","refpatogramme",
        ...
        'data'=>$data
            ...
            ->select("respiration","Fc_Apgar","refexes","toms_musculaire",
            "refexes","coloration","refpatogramme",
    ...
    function  mobile_insertData(Request $request)
    {
        ...
        $data = tmatapgar::create([
            'refpatogramme'  =>  $request->refpatogramme,
            'Fc_Apgar'  =>  $request->Fc_Apgar,
            'coloration'  =>  $request->coloration,
            'refexes'  =>  $request->refexes,
            'toms_musculaire'  =>  $request->toms_musculaire,
            'temps_APGAR'  =>  $request->temps_APGAR,
            'author'  =>  $request->author,
        ]);
        $lastId=$data->id;
        $data2 = DB::table('tmatapgar')
        ->join('tmat_partogramme','tmat_partogramme.id','=','tmatapgar.refpatogramme')
        ->join('tdetailconsultation','tdetailconsultation.id','=','tmat_partogramme.refDetailConst')
        ->join('tenteteconsulter','tenteteconsulter.id','=','tdetailconsultation.refEnteteCons') 
        ->join('ttypeconsultation','ttypeconsultation.id','=','tdetailconsultation.refTypeCons') 
 ...
 function updateData(Request $request, $id)
 {
         ...
         $data= tmatapgar::where('id',$request->id)->update([
            'refpatogramme'  =>  $request->refpatogramme,
            'Fc_Apgar'  =>  $request->Fc_Apgar,
            'coloration'  =>  $request->coloration,
            'refexes'  =>  $request->refexes,
 ...
 {
     $data = tmatapgar::where('id', $id)->delete();
