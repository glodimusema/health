...
use App\Models\Maternite\tmat_detail_affection;
use App\Traits\JsonResponseTrait; 
use App\Traits\{GlobalMethod,Slug};
use DB;

class tmat_detail_affectionController extends Controller
{
    ...
    { 
        ...
        if (!is_null($request->get('query'))) 
        {
            ...
            $data = DB::table('tmat_detail_affection')
            ->join('tmat_partogramme','tmat_partogramme.id','=','tmat_detail_affection.refpatogramme')
            ...
            ->select("tmat_detail_affection.id","affection","heure_apparition","traitement_normaux","tmat_detail_affection.author",
            ...
            ->orderBy("tmat_detail_affection.id", "desc")          
            ->paginate(10);
            ...
            ->select("affection","heure_apparition","traitement_normaux","tmat_detail_affection.author",
    ...
    function fetch_single_SurveillanceF($id)
    {
        ...
        "dateExpiration_malade")
        ->selectRaw('TIMESTAMPDIFF(YEAR, dateNaissance_malade, CURDATE()) as age_malade')
        ->where('tmat_detail_affection.id', $id)
        ->get();
    ...
    function insertData(Request $request)
    {
        ...
        $data = tmat_detail_affection::create([
            'refpatogramme'  => $request->refpatogramme,
            'heure_apparition'  =>  $request->heure_apparition,
            'traitement_normaux'  =>  $request->traitement_normaux,
 ...
 function updateData(Request $request, $id)
 {
         ...
         $data= tmat_detail_affection::where('id',$request->id)->update([
            'refpatogramme'  => $request->refpatogramme,
            'heure_apparition'  =>  $request->heure_apparition,
            'traitement_normaux'  =>  $request->traitement_normaux,
            'author'  =>  $request->author,
 ...
 {
     $data = tmat_detail_affection::where('id', $id)->delete();
