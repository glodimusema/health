...
class Pdf_DetailFacturePriveeController extends Controller
{
     /**
...
function showDetailFacturation($date1, $date2)
{
    ...
    'tfin_entetefacturation.statut as statutMvt','refDepartement','nom_uniteproduction',
    'code_uniteproduction','nom_departement','code_departement',"tfin_detailfacturation.author",
    ...
    "dateExpiration_malade",'refUniteProduction','refTypeProduit','refSscompte','nom_produit',
    ...
    { 
        ...
        <td class="cs6E02D7D2" style="width:178px;height:22px;line-height:15px;text-align:left;vertical-align:middle;">'.$row->nom_produit.'</td>
        <td class="cs6E02D7D2" colspan="2" style="width:91px;height:22px;line-height:15px;text-align:center;vertical-align:middle;">'.$row->quantite.'</td>
        <td class="cs6E02D7D2" colspan="3" style="width:64px;height:22px;line-height:15px;text-align:center;vertical-align:middle;">'.$row->prixunitaire.'$</td>
...
function printRapportDetailFacture_Departement($date1, $date2,$refDepartement)
{
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:909px;height:383px;position:relative;">
            ...
            <tr style="vertical-align:top;">
                ...
                <td></td>
                <td class="cs56F73198" colspan="4" style="width:329px;height:21px;line-height:18px;text-align:left;vertical-align:top;"><nobr>&nbsp;PERIODE&nbsp;:&nbsp;&nbsp;Du&nbsp;&nbsp;'.$date1.'&nbsp;&nbsp;au&nbsp;'.$date2.'</nobr></td>
                <td class="cs56F73198" colspan="10" style="width:562px;height:21px;line-height:18px;text-align:left;vertical-align:top;">'.$nom_departement.' - '.$code_departement.'</td>
            </tr>
            <tr style="vertical-align:top;">
                <td style="width:0px;height:9px;"></td>
                <td></td>
...
function printRapportDetailFacture_Service($date1, $date2,$refUniteProduction)
{
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:909px;height:383px;position:relative;">
            ...
            <tr style="vertical-align:top;">
                ...
                <td></td>
                <td class="cs56F73198" colspan="4" style="width:329px;height:21px;line-height:18px;text-align:left;vertical-align:top;"><nobr>&nbsp;PERIODE&nbsp;:&nbsp;&nbsp;Du&nbsp;&nbsp;'.$date1.'&nbsp;&nbsp;au&nbsp;'.$date2.'</nobr></td>
                <td class="cs56F73198" colspan="10" style="width:562px;height:21px;line-height:18px;text-align:left;vertical-align:top;">'.$nom_uniteproduction.' - '.$code_uniteproduction.'</td>
            </tr>
            <tr style="vertical-align:top;">
                <td style="width:0px;height:9px;"></td>
                <td></td>
...
function printRapportDetailFacture_Medecin($date1, $date2,$refMedecin)
{
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:909px;height:383px;position:relative;">
            ...
            <tr style="vertical-align:top;">
                ...
                <td></td>
                <td class="cs56F73198" colspan="4" style="width:329px;height:21px;line-height:18px;text-align:left;vertical-align:top;"><nobr>&nbsp;PERIODE&nbsp;:&nbsp;&nbsp;Du&nbsp;&nbsp;'.$date1.'&nbsp;&nbsp;au&nbsp;'.$date2.'</nobr></td>
                <td class="cs56F73198" colspan="10" style="width:562px;height:21px;line-height:18px;text-align:left;vertical-align:top;">'.$noms_medecin.' - '.$matricule_medecin.'</td>
            </tr>
            <tr style="vertical-align:top;">
                <td style="width:0px;height:9px;"></td>
                <td></td>
...
function printRapportDetailFacture_Medecin_Service($date1, $date2,$refMedecin,$refUniteProduction)
{
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:909px;height:383px;position:relative;">
            ...
            <tr style="vertical-align:top;">
                ...
                <td></td>
                <td class="cs56F73198" colspan="4" style="width:329px;height:21px;line-height:18px;text-align:left;vertical-align:top;"><nobr>&nbsp;PERIODE&nbsp;:&nbsp;&nbsp;Du&nbsp;&nbsp;'.$date1.'&nbsp;&nbsp;au&nbsp;'.$date2.'</nobr></td>
                <td class="cs56F73198" colspan="10" style="width:562px;height:21px;line-height:18px;text-align:left;vertical-align:top;">'.$noms_medecin.' - '.$nom_uniteproduction.'</td>
            </tr>
            <tr style="vertical-align:top;">
                <td style="width:0px;height:9px;"></td>
                <td></td>
...
//==================== RAPPORT DETAIL FACTURE SELON LE CAISSIERS =======================================
...
function printRapportDetailFacture_Caissier($date1, $date2,$author)
{
        ...
        ->get();
         ...
         ->where([
            ['datefacture','>=', $date1],
            ['datefacture','<=', $date2],
            ['tfin_detailfacturation.author','=', $author],
            ['categoriemaladiemvt','=', 'PRIVE(E)'],
        ])    
         ->get(); 
         $output='';
         ...
         ->select("tfin_detailfacturation.id",'refEnteteFacturation','refProduit','quantite',
         'prixunitaire','montant_taux','refMouvement','refUniteProduction','refMedecin','datefacture',
         'tfin_entetefacturation.statut as statutMvt',"tfin_entetefacturation.author",
         "tfin_detailfacturation.created_at","tfin_detailfacturation.updated_at",
         "matricule_medecin","noms_medecin","sexe_medecin","contact_medecin","mail_medecin",
         "grade_medecin","fonction_medecin","specialite_medecin","refMalade","refTypeMouvement",
         "dateMouvement",'organisationAbonne','taux_prisecharge',
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:909px;height:383px;position:relative;">
            ...
            <tr style="vertical-align:top;">
                ...
                <td></td>
                <td class="cs56F73198" colspan="4" style="width:329px;height:21px;line-height:18px;text-align:left;vertical-align:top;"><nobr>&nbsp;PERIODE&nbsp;:&nbsp;&nbsp;Du&nbsp;&nbsp;'.$date1.'&nbsp;&nbsp;au&nbsp;'.$date2.'</nobr></td>
                <td class="cs56F73198" colspan="10" style="width:562px;height:21px;line-height:18px;text-align:left;vertical-align:top;">'.$noms_Caissier.'</td>
            </tr>
            <tr style="vertical-align:top;">
                <td style="width:0px;height:9px;"></td>
                <td></td>
