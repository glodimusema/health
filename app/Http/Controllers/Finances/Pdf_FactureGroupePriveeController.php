...
class Pdf_FactureGroupePriveeController extends Controller
{
     /**
    ...
    function pdf_grand_facture_groupe_privee_data(Request $request)
    {

        if ($request->get('id')) 
        {
            $id = $request->get('id');
            $html = $this->getInfoGrandFactureGroupePrivee($id);
    ...
    function getInfoGrandFactureGroupePrivee($id)
    {
               //Info Entreprise
                $nomEse='';
                $adresseEse='';
               ...
               foreach ($data3 as $row) 
               {
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:708px;height:569px;position:relative;">
                    <tr>
                    ...
                    ';
                         ...
                         $output .= $this->showDetailGrandFactureGroupePriveeEntete($id); 
    ...
    function showDetailGrandFactureGroupePriveeEntete($id)
    {
        ...
        { 
            ...
            $output .='
                    ...
                    <td style="width:0px;height:24px;"></td>
                    <td></td>
                    <td class="cs58AC6944" colspan="11" style="width:586px;height:22px;line-height:15px;text-align:center;vertical-align:middle;">'.$row->nom_typeproduit.'</td>
                    <td class="cs36E0C1B8" colspan="2" style="width:109px;height:22px;line-height:15px;text-align:center;vertical-align:middle;">'.$row->prixTotal.'$</td>
                </tr>
                ';
                
                $output .= $this->showDetailGrandFacturePrivee($row->refEnteteFacturation,$row->refTypeProduit); 
    ...
    function showDetailGrandFacturePrivee($id,$refTypeProduit)
    {
        ...
        { 
            ...
            $output .='
                    ...
                    <td class="csDC7EEB9" colspan="3" style="width:331px;height:22px;line-height:13px;text-align:center;vertical-align:middle;">'.$row->nom_produit.'</td>
    ...
    //========= GRANDE FACTURE PRIVEE SELON LE MOUVEMENT =============================================================================
        ...
        //pdf_petit_facture_groupe_abonnee_data
    //pdf_petit_facture_groupe_abonnee_mouvement_data
    //pdf_grand_facture_groupe_abonnee_mouvement_data


    //pdf_petit_facture_groupe_privee_mouvement_data
    //pdf_petit_facture_groupe_privee_data
    //pdf_grand_facture_groupe_privee_mouvement_data

    function pdf_grand_facture_groupe_privee_mouvement_data(Request $request)
    {

        if ($request->get('id')) 
        {
            $id = $request->get('id');
            $html = $this->getInfoGrandFactureGroupePriveeMouvement($id);
            $pdf = \App::make('dompdf.wrapper');
    ...
    function getInfoGrandFactureGroupePriveeMouvement($id)
    {
               //Info Entreprise
                $nomEse='';
                $adresseEse='';
               ...
               foreach ($data3 as $row) 
               {
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:708px;height:569px;position:relative;">
                    ...
                    ';
                         ...
                         $output .= $this->showDetailGrandFactureGroupePriveeMouvement($id); 
    ...
    function showDetailGrandFactureGroupePriveeMouvement($id)
    {
        $data = DB::select('select refEnteteFacturation,prixTotal,refMouvement,
        refUniteProduction,refMedecin,datefacture,tfin_entetefacturation.statut as statutMvt,
        matricule_medecin,noms_medecin,sexe_medecin,contact_medecin,mail_medecin,
        ...
        { 
            ...
            $output .='
                ...
                $output .= $this->showDetailGrandFacturePriveeMouvement($row->refMouvement,$row->refTypeProduit); 
    ...
    function showDetailGrandFacturePriveeMouvement($id,$refTypeProduit)
    {
        $data = DB::table('tfin_detailfacturation')
        ->join('tfin_entetefacturation','tfin_entetefacturation.id','=','tfin_detailfacturation.refEnteteFacturation')
        ->join('tmedecin','tmedecin.id','=','tfin_entetefacturation.refMedecin')
    ...
    //========================================================================================================================================================
    //===================== PETITE FACTURE GROUPE ENTETE


    function pdf_petit_facture_groupe_privee_data(Request $request)
    {

        if ($request->get('id')) 
        {
            $id = $request->get('id');
            $html = $this->getInfoPetitFactureGroupePrivee($id);
            $pdf = \App::make('dompdf.wrapper');
    ...
    function getInfoPetitFactureGroupePrivee($id)
    {
               //Info Entreprise
                $nomEse='';
                $adresseEse='';
               ...
               foreach ($data3 as $row) 
               {
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:409px;height:582px;position:relative;">
                    ...
                    ';
                        ...
                        $output .= $this->showDetailPetitFactureGroupePriveeEntete($id); 
    ...
    function showDetailPetitFactureGroupePriveeEntete($id)
    {
        $data = DB::select('select refEnteteFacturation,prixTotal,refMouvement,
        refUniteProduction,refMedecin,datefacture,tfin_entetefacturation.statut as statutMvt,
        matricule_medecin,noms_medecin,sexe_medecin,contact_medecin,mail_medecin,
        ...
        { 
            ...
            $output .='                    
                    <tr style="vertical-align:top;">
                        <td style="width:0px;height:22px;"></td>
                        <td></td>
                        <td class="cs10569A86" colspan="10" style="width:254px;height:20px;line-height:15px;text-align:left;vertical-align:middle;">'.$row->nom_typeproduit.'</td>
                        <td class="cs32E815B6" colspan="3" style="width:62px;height:20px;line-height:13px;text-align:center;vertical-align:middle;">'.$row->prixTotal.'$</td>
                        <td></td>
                    </tr>                  
                ';
                
                $output .= $this->showDetailPetitFacturePrivee($row->refEnteteFacturation,$row->refTypeProduit); 
    ...
    function showDetailPetitFacturePrivee($id,$refTypeProduit)
    {
        $data = DB::table('tfin_detailfacturation')
        ->join('tfin_entetefacturation','tfin_entetefacturation.id','=','tfin_detailfacturation.refEnteteFacturation')
        ->join('tmedecin','tmedecin.id','=','tfin_entetefacturation.refMedecin')
        ...
        { 
            ...
            $output .='
                <tr style="vertical-align:top;">
                    <td style="width:0px;height:22px;"></td>
                    <td></td>
                    <td class="cs8F206BC7" colspan="5" style="width:173px;height:20px;line-height:12px;text-align:left;vertical-align:middle;">'.$row->nom_produit.'</td>
...
//========================================================================================================================================================
//===================== PETITE FACTURE GROUPE MOUVEMENT


    function pdf_petit_facture_groupe_privee_mouvement_data(Request $request)
    {

        if ($request->get('id')) 
        {
            $id = $request->get('id');
            $html = $this->getInfoPetitFactureGroupePriveeMouvement($id);
            $pdf = \App::make('dompdf.wrapper');
    ...
    function getInfoPetitFactureGroupePriveeMouvement($id)
    {
               //Info Entreprise
                $nomEse='';
                $adresseEse='';
               ...
               foreach ($data3 as $row) 
               {
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:409px;height:582px;position:relative;">
                    ...
                    ';
                        ...
                        $output .= $this->showDetailPetitFactureGroupePriveeMouvement($id); 
    ...
    function showDetailPetitFactureGroupePriveeMouvement($id)
    {
        $data = DB::select('select refEnteteFacturation,prixTotal,refMouvement,
        refUniteProduction,refMedecin,datefacture,tfin_entetefacturation.statut as statutMvt,
        matricule_medecin,noms_medecin,sexe_medecin,contact_medecin,mail_medecin,
        ...
        { 
            ...
            $output .='                    
                ...
                $output .= $this->showDetailPetitFacturePriveeMouvement($row->refMouvement,$row->refTypeProduit); 
    ...
    function showDetailPetitFacturePriveeMouvement($id,$refTypeProduit)
    {
        $data = DB::table('tfin_detailfacturation')
        ->join('tfin_entetefacturation','tfin_entetefacturation.id','=','tfin_detailfacturation.refEnteteFacturation')
        ->join('tmedecin','tmedecin.id','=','tfin_entetefacturation.refMedecin')
