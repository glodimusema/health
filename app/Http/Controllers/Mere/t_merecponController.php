...
use App\Models\Mere\t_merecpon;
use App\Traits\{GlobalMethod,Slug};
use DB;


class t_merecponController extends Controller
{
    ...
    { 
        if (!is_null($request->get('query'))) 
        {
            ...
            $data = DB::table('t_merecpon')
            ->join('t_mere_periode_cpon','t_mere_periode_cpon.id','=','t_merecpon.refPeriode_CPON')
            ->join('t_mere_consultation_prenatale','t_mere_consultation_prenatale.id','=','t_merecpon.refCPN')
            ...
            ->select("t_merecpon.id","date_recusCPON",
            "poids_cpon","name_periode","dure_periode","refCPN","refPeriode_CPON",
            "t_merecpon.author",
    ...
    //id,refCPN,refPeriode_CPON,date_recusCPON,poids_cpon,author

 function insertData(Request $request)
 {
        $data= t_merecpon::create([
            'refCPN'=>$request->refCPN,
            'refPeriode_CPON'=>$request->refPeriode_CPON,
            'date_recusCPON'=>$request->date_recusCPON,
            'poids_cpon'=>$request->poids_cpon,            
 ...
 {
        $data= t_merecpon::where('id',$request->id)->update([
            'refCPN'=>$request->refCPN,
            'refPeriode_CPON'=>$request->refPeriode_CPON,
            'date_recusCPON'=>$request->date_recusCPON,
            'poids_cpon'=>$request->poids_cpon,            
 ...
 {
     $data = t_merecpon::where('id', $id)->delete();
     return response()->json([
