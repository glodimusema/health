...
class t_mere_rendez_vous_vac_mereController extends Controller
{
    ...
    { 
        if (!is_null($request->get('query'))) 
        {
            ...
            $data = DB::table('t_mere_rendez_vous_vac_mere')
            ->join('t_mere_periode_vacciniere','t_mere_periode_vacciniere.id','=','t_mere_rendez_vous_vac_mere.refPeriode')
            ->join('t_mere_consultation_prenatale','t_mere_consultation_prenatale.id','=','t_mere_rendez_vous_vac_mere.refCPN')
            ...
            ->select("t_mere_rendez_vous_vac_mere.id","date_RDV","compteurRDV","refCPN","refPeriode",
            "t_mere_rendez_vous_vac_mere.author","nom_periode","etatRdv",
            ...
            ->orderBy("t_mere_rendez_vous_vac_mere.id", "asc")          
            ->paginate(10);
            ...
            ->select("t_mere_rendez_vous_vac_mere.id","date_RDV","compteurRDV","refCPN","refPeriode",
            "t_mere_rendez_vous_vac_mere.author","nom_periode",
            "rh","electropherese","date_debut",
            "personne_contact","adresse_personne_ref","date_DDr","date_DPA","primipare",
            "plus_35","tbc","hta","sca","dbt","car","mef","raa","syphylis","vIH_sida","vvS",
            "vvS","pEP","cesarienne","cerciage","cerciage","fibrame","fature_bassin",
            ...
            "date_du_debutCTX","aZT","tAR","cd4","dors_mil_oui","fer_acide","apres_Accouchement",
             ...
             "methodePFchoisie","dCIP","pTME","resultat_test1","date_annonce1","partenaire_date1",
             "resultat_test2","date_annonce2"  ,"plau_accouchement",
             "t_mere_consultation_prenatale.author","etatRdv",
    ...
    {     
        ...
        if (!is_null($request->get('query'))) {
            ...
            ->select("t_mere_rendez_vous_vac_mere.id","date_RDV","compteurRDV","refCPN","refPeriode",
            "t_mere_rendez_vous_vac_mere.author","nom_periode",
            "rh","electropherese","date_debut","etatRdv",
            "personne_contact","adresse_personne_ref","date_DDr","date_DPA","primipare",
            "plus_35","tbc","hta","sca","dbt","car","mef","raa","syphylis","vIH_sida","vvS",
            "vvS","pEP","cesarienne","cerciage","cerciage","fibrame","fature_bassin",
            "gEU","fistule","uterus_cicatrice","traitement_sterilite","parite","parite",
    ...
    function fetch_single($id)
    {
        $data = DB::table('t_mere_rendez_vous_vac_mere')
            ...
            "dateExpiration_malade")
            ->selectRaw('TIMESTAMPDIFF(YEAR, dateNaissance_malade, CURDATE()) as age_malade')
        ->where('t_mere_rendez_vous_vac_mere.id', $id)
        ->get();
 ...
 function insertData(Request $request)
 {
        ...
        $data= t_mere_rendez_vous_vac_mere::create([
            'refCPN'=>$idEnteteVac,
         ...
         return response()->json(['data'=>'Insertion avec succes!!']);
     }
     

 //id,refCPN,refPeriode,date_RDV,etatRdv,compteurRDV,author

 function updateData(Request $request)
 {
        $data= t_mere_rendez_vous_vac_mere::where('id',$request->id)->update([
            'refCPN'=>$idEnteteVac,
            'refPeriode'=>$idPeriode,
            'date_RDV'=>$daterdv,
            'etatRdv'=>0,
...
public function fetch_rdv_mere(Request $request)
{  
    if (($request->get('refPeriode')) && ($request->get('refCPN'))) 
    {
        $refPeriode = $request->get('refPeriode');
        $refCPN = $request->get('refCPN');
        ...
        ->select("t_mere_rendez_vous_vac_mere.id","date_RDV","compteurRDV","refCPN","refPeriode",
        "t_mere_rendez_vous_vac_mere.author","etatRdv",
        "rh","electropherese","date_debut",
        "personne_contact","adresse_personne_ref","date_DDr","date_DPA","primipare",
        "plus_35","tbc","hta","sca","dbt","car","mef","raa","syphylis","vIH_sida","vvS",
        "vvS","pEP","cesarienne","cerciage","cerciage","fibrame","fature_bassin",
 ...
 {
     $data = t_mere_rendez_vous_vac_mere::where('id', $id)->delete();

     return response()->json(['data'=>'Suppression avec succes!!']);
 }
