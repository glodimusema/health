...
use App\Models\Mere\t_mere_peni;
use App\Traits\{GlobalMethod,Slug};
use DB;

//t_mere_peniController t_periode_peni_mere

class t_mere_peniController extends Controller
{
    ...
    { 
        if (!is_null($request->get('query'))) 
        {
            ...
            $data = DB::table('t_mere_peni')
            ->join('t_periode_peni_mere','t_periode_peni_mere.id','=','t_mere_peni.refPeriode_Peni')
            ->join('t_mere_consultation_prenatale','t_mere_consultation_prenatale.id','=','t_mere_peni.refCPN')
            ...
            ->select("t_mere_peni.id","date_recusPeni",
            "poids_Peni","name_periode","dure_periode","refCPN","refPeriode_Peni",
            "t_mere_peni.author","date_recusPeni","poids_Peni",
 ...
 {
        $data= t_mere_peni::create([
            'refCPN'=>$request->refCPN,
            'refPeriode_Peni'=>$request->refPeriode_Peni,
            'date_recusPeni'=>$request->date_recusPeni,
            'poids_Peni'=>$request->poids_Peni,            
 ...
 //date_recusPeni,poids_Peni

 function updateData(Request $request)
 {
        $data= t_mere_peni::where('id',$request->id)->update([
            'refCPN'=>$request->refCPN,
            'refPeriode_Peni'=>$request->refPeriode_Peni,
            'date_recusPeni'=>$request->date_recusPeni,
            'poids_Peni'=>$request->poids_Peni,            
 ...
 {
     $data = t_mere_peni::where('id', $id)->delete();
     return response()->json([
