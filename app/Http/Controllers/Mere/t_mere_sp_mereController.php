...
use App\Models\Mere\t_mere_sp_mere;
use App\Traits\{GlobalMethod,Slug};
use DB;


class t_mere_sp_mereController extends Controller
{
    ...
    { 
        if (!is_null($request->get('query'))) 
        {
            ...
            $data = DB::table('t_mere_sp_mere')
            ->join('t_mere_periode_sp','t_mere_periode_sp.id','=','t_mere_sp_mere.refPeriode_sp')
            ->join('t_mere_consultation_prenatale','t_mere_consultation_prenatale.id','=','t_mere_sp_mere.refCPN')
            ...
            ->select("t_mere_sp_mere.id","date_recuSp","poids_sp",
             "name_periode_Sp","dure_periode_sp","refCPN","refPeriode_sp",
            "t_mere_sp_mere.author",
            ...
            ->orderBy("t_mere_sp_mere.id", "desc")          
            ->paginate(10);
            ...
            ->select("t_mere_sp_mere.id","date_recuSp",
             "name_periode_Sp","dure_periode_sp","refCPN","refPeriode_sp",
            "t_mere_sp_mere.author",
 ...
 {
        $data= t_mere_sp_mere::create([
            'refCPN'=>$request->refCPN,
            'refPeriode_sp'=>$request->refPeriode_sp,
            'date_recuSp'=>$request->date_recuSp,
            'poids_sp'=>$request->poids_sp,          
 ...
 //id,refCPN,refPeriode_sp,date_recuSp,poids_sp,author

 function updateData(Request $request)
 {
        $data= t_mere_sp_mere::where('id',$request->id)->update([
            'refCPN'=>$request->refCPN,
            'refPeriode_sp'=>$request->refPeriode_sp,
            'date_recuSp'=>$request->date_recuSp,
            'poids_sp'=>$request->poids_sp,          
 ...
 {
     $data = t_mere_sp_mere::where('id', $id)->delete();
     return response()->json([
