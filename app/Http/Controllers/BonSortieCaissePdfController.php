...
class BonSortieCaissePdfController extends Controller
{
     /**
    ...
    function getInfoFactureTug($id)
    {
                ...
                <html>
                <head>
                    <title>BON DE SORTIE CAISSE</title>
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:727px;height:706px;position:relative;">
                    ...
                    <tr style="vertical-align:top;">
                        ...
                        <td class="cs52B43ED7" colspan="6" rowspan="7" style="width:162px;height:149px;text-align:left;vertical-align:top;"><div style="overflow:hidden;width:162px;height:149px;">
                    ...
                    <tr style="vertical-align:top;">
                        ...
                        <td class="cs8E6BFA72" colspan="10" rowspan="3" style="width:333px;height:33px;line-height:32px;text-align:left;vertical-align:top;"><nobr>BON&nbsp;DE&nbsp;SORTIE&nbsp;CAISSE</nobr></td>
                    ...
                    <tr style="vertical-align:top;">
                        ...
                        <td class="csE5F297B" colspan="23" style="width:601px;height:27px;line-height:18px;text-align:left;vertical-align:top;">'.$Compte.' - '.$nom_banque.' - '.$numeroBE.'</td>
                        <td class="csEBB30003" colspan="2" style="width:17px;height:30px;"></td>
                    </tr>
                    <tr style="vertical-align:top;">
                        <td style="width:0px;height:11px;"></td>
                    ...
                    <tr style="vertical-align:top;">
                        ...
                        <td class="cs62767105" colspan="9" style="width:173px;height:20px;line-height:18px;text-align:left;vertical-align:top;"><nobr>Date&nbsp;:&nbsp;'.$dateOperation.'</nobr></td>
                    ...
                    <tr style="vertical-align:top;">
                        ...
                        <td class="cs62767105" colspan="5" rowspan="2" style="width:118px;height:40px;line-height:18px;text-align:left;vertical-align:top;"><nobr>Pour</nobr><br/><nobr>autorisation</nobr></td>
                    ...
                    <tr style="vertical-align:top;">
                        ...
                        <td class="cs79DF234B" colspan="7" style="width:181px;height:16px;line-height:13px;text-align:left;vertical-align:middle;"><nobr>DATE:&nbsp;'.$DateApproCoordi.'</nobr></td>
                        <td class="cs101A94F7" colspan="2" style="width:82px;height:22px;"></td>
                        <td class="cs79DF234B" colspan="6" style="width:180px;height:16px;line-height:13px;text-align:left;vertical-align:middle;"><nobr>DATE:&nbsp;'.$dateOperation.'</nobr></td>
                        <td class="cs101A94F7" colspan="4" style="width:56px;height:22px;"></td>
                        <td class="cs79DF234B" colspan="8" style="width:180px;height:16px;line-height:13px;text-align:left;vertical-align:middle;"><nobr>DATE:&nbsp;'.$DateAcquitterPar.'</nobr></td>
...
public function fetch_rapport_sortie_compte_date(Request $request)
{
    //
