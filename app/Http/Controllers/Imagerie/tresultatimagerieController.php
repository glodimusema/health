...
use App\Models\Imagerie\tim_resultat_imagerie;
use App\Traits\{GlobalMethod,Slug};
use DB;


class tresultatimagerieController extends Controller
{
    ...
    {          
        ...
        if (!is_null($request->get('query'))) 
        {
            ...
            ->where([
                ...
                ['tim_resultat_imagerie.deleted','NON']
            ])           
            ->orderBy("tim_resultat_imagerie.id", "desc")          
            ->paginate(10);
...
//'id','refImagerie','technique_res','description_res','conclusion_res','image_res'
 function insertData(Request $request)
 {
     ...
     if (!is_null($request->image)) 
     {
        $formData = json_decode($_POST['data']);
         ...
         $data= tim_resultat_imagerie::create([
 ...
 function updateData(Request $request)
 {
     ...
     if (!is_null($request->image)) 
     {
        ...
        $data= tim_resultat_imagerie::where('id',$formData->id)->update([
            'refImagerie' =>  $formData->refImagerie,
            'technique_res'       => $formData->technique_res,
            'description_res'     =>   $formData->description_res,
            'conclusion_res'         =>  $formData->conclusion_res,
 ...
 {
     $data = tim_resultat_imagerie::where('id', $id)->delete();
