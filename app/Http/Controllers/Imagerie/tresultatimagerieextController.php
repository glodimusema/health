...
use App\Models\Imagerie\tim_resultat_imagerie_ext;
use App\Traits\{GlobalMethod,Slug};
use DB;


class tresultatimagerieextController extends Controller
{
    ...
    {          
        ...
        if (!is_null($request->get('query'))) 
        {
            ...
            ->where([
                ...
                ['tim_resultat_imagerie_ext.deleted','NON']
            ])           
            ->orderBy("tim_resultat_imagerie_ext.id", "desc")          
            ->paginate(10);
    ...
    public function fetch_resultat_imagerie(Request $request,$refImagerie)
    { 
    ...
    public function fetch_resultat_imagerie_valide(Request $request,$refImagerie)
    { 
    ...
    function fetch_single_ResultatImage($id)
    {
        $data = DB::table('tim_resultat_imagerie_ext')
        ->join('tim_imagerie_ext','tim_imagerie_ext.id','=','tim_resultat_imagerie_ext.refImagerie')
        ->join('tim_analyse','tim_analyse.id','=','tim_imagerie_ext.refAnalyse')
 ...
 function insertData(Request $request)
 {
     ...
     if (!is_null($request->image)) 
     {
        $formData = json_decode($_POST['data']);
         ...
         $data= tim_resultat_imagerie_ext::create([
            'refImagerie' =>  $formData->refImagerie,
            'technique_res'       => $formData->technique_res,
            'description_res'     =>   $formData->description_res,
            'conclusion_res'         =>  $formData->conclusion_res,    
            'image_res'            =>  $imageName,                         
 ...
 function updateData(Request $request)
 {
     ...
     if (!is_null($request->image)) 
     {
        ...
        $data= tim_resultat_imagerie_ext::where('id',$formData->id)->update([
            'refImagerie' =>  $formData->refImagerie,
            'technique_res'       => $formData->technique_res,
            'description_res'     =>   $formData->description_res,
            'conclusion_res'         =>  $formData->conclusion_res,
 ...
 {
     $data = tim_resultat_imagerie_ext::where('id', $id)->delete();
