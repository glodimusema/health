...
use App\Models\Imagerie\tim_coloscopie;
use App\Traits\{GlobalMethod,Slug};
use DB;


class tim_coloscopieController extends Controller
{
    ...
    { 
        ...
        if (!is_null($request->get('query'))) 
        {
            ...
            $data = DB::table('tim_coloscopie')
            ->join('tim_imagerie','tim_imagerie.id','=','tim_coloscopie.refImagerie')
            ...
            ->select("tim_coloscopie.id","inspection","toucherRectal","anuscopie","coloscopie",
            "biopsies","tim_coloscopie.conclusion","image_colorscopie","refImagerie","tim_coloscopie.author",
            //-------------------------------------------------------------------
            ...
            ->where([
                ['noms', 'like', '%'.$query.'%'],
                ['tim_coloscopie.deleted','NON']
            ])           
            ->orderBy("tim_coloscopie.id", "desc")          
            ->paginate(10);
...
function insertData(Request $request)
 ...
 function updateData(Request $request)
 {
     ...
     if (!is_null($request->image)) 
     {
        ...
        $data= tim_coloscopie::where('id',$formData->id)->update([
            'refImagerie'=>$formData->refImagerie,
            'inspection'       =>$formData->inspection,
            'toucherRectal'     =>  $formData->toucherRectal,
            'anuscopie'         => $formData->anuscopie,    
 ...
 {
     $data = tim_coloscopie::where('id', $id)->delete();
