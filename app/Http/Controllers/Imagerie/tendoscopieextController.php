...
use App\Models\Imagerie\tim_endoscopie_ext;
use App\Traits\{GlobalMethod,Slug};
use DB;


class tendoscopieextController extends Controller
{
    ...
    {          
        ...
        if (!is_null($request->get('query'))) 
        {
            ...
            $data = DB::table('tim_endoscopie_ext')
            ->join('tim_imagerie_ext','tim_imagerie_ext.id','=','tim_endoscopie_ext.refImagerie')
            ...
            ->select("tim_endoscopie_ext.id",'refImagerie','descriptionEndo','conclusionEndo','imageEndo',
            ...
            ->where([
                ...
                ['tim_endoscopie_ext.deleted','NON']
            ])           
            ->orderBy("tim_endoscopie_ext.id", "desc")          
            ->paginate(10);
    ...
    function fetch_single_EndoscopieImage($id)
    {
        ...
        "dateExpiration_malade")
        ->selectRaw('TIMESTAMPDIFF(YEAR, dateNaissance_malade, CURDATE()) as age_malade')
        ->where('tim_endoscopie_ext.id', $id)
        ->get();
 ...
 function insertData(Request $request)
 {
     ...
     if (!is_null($request->image)) 
     {
        $formData = json_decode($_POST['data']);
         ...
         $data= tim_endoscopie_ext::create([
 ...
 function updateData(Request $request)
 {
     ...
     if (!is_null($request->image)) 
     {
        ...
        $data= tim_endoscopie_ext::where('id',$formData->id)->update([
            'refImagerie' =>  $formData->refImagerie,
            'descriptionEndo'       => $formData->descriptionEndo,
            'conclusionEndo'     =>   $formData->conclusionEndo,           
            'imageEndo'            =>  $imageName,                           
 ...
 {
     $data = tim_endoscopie_ext::where('id', $id)->delete();
