...
use App\Models\Imagerie\tim_rectoscopie;
use App\Traits\{GlobalMethod,Slug};

use DB;


class tim_rectoscopieController extends Controller
{
    ...
    { 
        ...
        if (!is_null($request->get('query'))) 
        {
            ...
            $data = DB::table('tim_rectoscopie')
            ->join('tim_imagerie','tim_imagerie.id','=','tim_rectoscopie.refImagerie')
            ...
            ->select("tim_rectoscopie.id","inspection","toucherRectal","image_rectoscopie","anuscopie","rectoscopie","conclusion_recto",
                     "tim_rectoscopie.author",
            //-------------------------------------------------------------------
            ...
            ->where([
                ['noms', 'like', '%'.$query.'%'],          
                ['status','Encours'],
                ['tim_rectoscopie.deleted','NON']
            ])           
            ->orderBy("tim_rectoscopie.id", "desc")          
            ->paginate(10);
...
function insertData(Request $request)
 ...
 function updateData(Request $request)
 {
     ...
     if (!is_null($request->image)) 
     {
        ...
        $data= tim_rectoscopie::where('id',$formData->id)->update([
 ...
 {
     $data = tim_rectoscopie::where('id', $id)->delete();
