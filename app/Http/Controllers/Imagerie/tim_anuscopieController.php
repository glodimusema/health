...
use App\Models\Imagerie\tim_anuscopie;
use App\Traits\{GlobalMethod,Slug};

use DB;


class tim_anuscopieController extends Controller
{
    ...
    { 
        ...
        if (!is_null($request->get('query'))) 
        {
            ...
            $data = DB::table('tim_anuscopie')
            ->join('tim_imagerie','tim_imagerie.id','=','tim_anuscopie.refImagerie')
            ...
            ->select("tim_anuscopie.id","inspection","toucherRectal","anuscopie",
            "tim_anuscopie.conclusion","photo_anuscopie","refImagerie","tim_anuscopie.author",
            //-------------------------------------------------------------------            
            ...
            ->where([
                ['noms', 'like', '%'.$query.'%'],          
                ['status','Encours'],
                ['tim_anuscopie.deleted','NON']
            ])           
            ->orderBy("tim_anuscopie.id", "desc")          
            ->paginate(10);
...
function insertData(Request $request)
 ...
 function updateData(Request $request)
 {
     ...
     if (!is_null($request->image)) 
     {
        ...
        $data= tim_anuscopie::where('id',$formData->id)->update([
 ...
 {
     $data = tim_anuscopie::where('id', $id)->delete();
