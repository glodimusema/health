...
use App\Models\Attestation\tt_attest_certificat_deces;
use DB;

class tt_attest_certificat_decesController extends Controller
{
    ...
    { 
        ...
        if (!is_null($request->get('query'))) 
        {
            ...
            "tt_attest_entete_attestation.author","refAttestation","refDetailConst",
            ...
            ->where([
                ['noms', 'like', '%'.$query.'%'],
                ['tt_attest_certificat_deces.deleted','NON']
            ])           
            ->orderBy("tt_attest_certificat_deces.id", "desc")          
            ->paginate(10);
    ...
    public function fetch_certificatdeces_entete(Request $request,$refAttestation)
    { 
    ...
    function fetch_single_certificat($id)
    {
        $data = DB::table('tt_attest_certificat_deces')
        ->join('tt_attest_entete_attestation','tt_attest_entete_attestation.id','=','tt_attest_certificat_deces.refAttestation')
        ->join('tdetailconsultation','tdetailconsultation.id','=','tt_attest_entete_attestation.refDetailConst')
    ...
    {
        $data = tt_attest_certificat_deces::create([
            'refAttestation'       =>  $request->refAttestation,
            'dateAdmise'    =>  $request->dateAdmise,
            'heure'    =>  $request->heure,
    ...
    {
        $data = tt_attest_certificat_deces::where('id', $id)->update([
            'refAttestation'       =>  $request->refAttestation,
            'dateAdmise'    =>  $request->dateAdmise,
            'heure'    =>  $request->heure,
            'author'    =>  $request->author    
 ...
 {
     $data = tt_attest_certificat_deces::where('id', $id)->delete();
