...
use App\Models\Chirurgie\tope_consentement;
use DB;

class tconsentementController extends Controller
{
    ...
    //
        ...
        if (!is_null($request->get('query'))) {
            ...
            $data = DB::table('tope_consentement')
            ->join('tope_enteteoperation','tope_enteteoperation.id','=','tope_consentement.refEnteteOpe')
            ...
            //MALADE
            ->select("tope_consentement.id",'refDetailCons','refEnteteOpe','dateConsentement',
            'chirurgien','anesthesiste','intervention','prevision','actechirurgie',
             "tope_consentement.author", "tope_consentement.created_at", "tope_consentement.updated_at",
            ...
            ->orderBy("tope_consentement.id", "desc")          
            ->paginate(10);
   ...
   //'id','refEnteteOpe','dateConsentement','chirurgien','anesthesiste','intervention',
    ...
    function insert_detail(Request $request)
    {
        ...
        $data = tope_consentement::create([
            ...
            'actechirurgie'    =>  $request->actechirurgie,                                        
    ...
    {
        $data = tope_consentement::where('id', $id)->update([
            'refEnteteOpe'       =>  $request->refEnteteOpe,
            'dateConsentement'    =>  $request->dateConsentement,
            'chirurgien'    =>  $request->chirurgien,
            'anesthesiste'    =>  $request->anesthesiste,
    ...
    {
        $data = tope_consentement::where('id',$id)->delete();
        return response()->json([
