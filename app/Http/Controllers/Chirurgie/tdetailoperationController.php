...
use App\Models\Chirurgie\tope_detailoperation;
use DB;

class tdetailoperationController extends Controller
{
    ...
    //
        ...
        if (!is_null($request->get('query'))) {
            ...
            $data = DB::table('tope_detailoperation')
            ...
            //MALADE
            ->select("tope_detailoperation.id",'refDetailCons','refEnteteOpe','datedetailOpe','diagnosticPresOpe','anesthesiste','chirurgien',
            'assistant','infirmiercirculant','diagnosticPostOpe','perteSanguine','Complication','instructionPrescription',"dateeneteop",
             "tope_detailoperation.author", "tope_detailoperation.created_at", "tope_detailoperation.updated_at",
    ...
    function fetch_single_detail($id)
    {
        ...
        "dateExpiration_malade","PrixCons")
        ->selectRaw('TIMESTAMPDIFF(YEAR, dateNaissance_malade, CURDATE()) as age_malade')
        ->where('tope_detailoperation.id', $id)
            ->get();
   ...
   //'id','refEnteteOpe','datedetailOpe','diagnosticPresOpe','anesthesiste','chirurgien',
    ...
    function insert_detail(Request $request)
    {
        ...
        $data = tope_detailoperation::create([
            'refEnteteOpe'       =>  $request->refEnteteOpe,
            'datedetailOpe'    =>  $request->datedetailOpe,
            'diagnosticPresOpe'    =>  $request->diagnosticPresOpe,
            'anesthesiste'    =>  $request->anesthesiste,
            'chirurgien'    =>  $request->chirurgien,
            'assistant'    =>  $request->assistant,
            'infirmiercirculant'    =>  $request->infirmiercirculant,
            'diagnosticPostOpe'    =>  $request->diagnosticPostOpe,
            'perteSanguine'    =>  $request->perteSanguine,
            'Complication'    =>  $request->Complication,
            'instructionPrescription'    =>  $request->instructionPrescription,                              
    ...
    {
        $data = tope_detailoperation::where('id', $id)->update([
            'refEnteteOpe'       =>  $request->refEnteteOpe,
            'datedetailOpe'    =>  $request->datedetailOpe,
            'diagnosticPresOpe'    =>  $request->diagnosticPresOpe,
            'anesthesiste'    =>  $request->anesthesiste,
    ...
    {
        $data = tope_detailoperation::where('id',$id)->delete();
        return response()->json([
