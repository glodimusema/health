...
use App\Models\Consultations\tcons_transfert;
use DB;

class tcons_transfertController extends Controller
{
    ...
    //
        ...
        if (!is_null($request->get('query'))) {
            ...
            //MALADE
            ->select("tcons_transfert.id",'refDetailCons','hopital_transfert','date_admission','heure_admission','diagnostic_tranfert',
            ...
            ->orderBy("tcons_transfert.id", "desc")          
            ->paginate(10);
   ...
   //traitement_tranfert,motif_tranfert,date_transfert,heure_transfert.hopital_transfert,medecin,specialite,cnom,author
    function insert_data(Request $request)
    {
       
        $data = tcons_transfert::create([
            'refDetailCons'       =>  $request->refDetailCons,
            'date_admission'    =>  $request->date_admission, 
            'heure_admission'    =>  $request->heure_admission, 
            'diagnostic_tranfert'    =>  $request->diagnostic_tranfert, 
            'bilan_tranfert'    =>  $request->bilan_tranfert, 
            'traitement_tranfert'    =>  $request->traitement_tranfert,
            'motif_tranfert'    =>  $request->motif_tranfert, 
            'date_transfert'    =>  $request->date_transfert,
            'heure_transfert'    =>  $request->heure_transfert, 
            'hopital_transfert'    =>  $request->hopital_transfert, 
            'medecin_transfert'    =>  $request->medecin_transfert, 
            'specialite_transfert'    =>  $request->specialite_transfert, 
            'cnom_transfert'    =>  $request->cnom_transfert,
    ...
    {
        $data = tcons_transfert::where('id', $id)->update([
            'refDetailCons'       =>  $request->refDetailCons,
            'date_admission'    =>  $request->date_admission, 
            'heure_admission'    =>  $request->heure_admission, 
            'diagnostic_tranfert'    =>  $request->diagnostic_tranfert, 
    ...
    {
        $data = tcons_transfert::where('id',$id)->delete();
        return response()->json([
