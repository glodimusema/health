...
use App\Models\Consultations\tcons_retroinformation;
use DB;

class tcons_retroinformationController extends Controller
{
    ...
    //
        ...
        if (!is_null($request->get('query'))) {
            ...
            ->orderBy("tcons_retroinformation.id", "desc")          
            ->paginate(10);
   ...
   ////id,refDetailCons,date_arrivee,heure_arrivee,diagnostic_retenu,traitement_retenu,
   //modalite_sortie,recommandations,date_retro,hopitals,author

    function insert_data(Request $request)
    {
       
        $data = tcons_retroinformation::create([
            'refDetailCons'       =>  $request->refDetailCons,
            'date_arrivee'    =>  $request->date_arrivee, 
            'heure_arrivee'    =>  $request->heure_arrivee, 
            'diagnostic_retenu'    =>  $request->diagnostic_retenu, 
            'traitement_retenu'    =>  $request->traitement_retenu, 
            'modalite_sortie'    =>  $request->modalite_sortie,
            'recommandations'    =>  $request->recommandations, 
            'date_retro'    =>  $request->date_retro,
            'hopitals'    =>  $request->hopitals,
    ...
    {
        $data = tcons_retroinformation::where('id', $id)->update([
            'refDetailCons'       =>  $request->refDetailCons,
            'date_arrivee'    =>  $request->date_arrivee, 
            'heure_arrivee'    =>  $request->heure_arrivee, 
            'diagnostic_retenu'    =>  $request->diagnostic_retenu, 
    ...
    {
        $data = tcons_retroinformation::where('id',$id)->delete();
        return response()->json([
