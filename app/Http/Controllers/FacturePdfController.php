...
class FacturePdfController extends Controller
{
    ...
    function getInfoFactureTug($id)
    {
                ...
                $data = vEnteteVente::select(['id','refClient','dateVente','dateExecution','Executant','author','noms','contact','mail','refAvenue','refCategieClient','CategorieClient','photo','slug','nomAvenue','idCommune','nomQuartier','idQuartier','idVille','nomCommune','idProvince','nomVille','idPays','nomProvince','nomPays','created_at','TotalVente'])
                ->Where('id',$id) 
                ->get();
                $output='';
                foreach ($data as $row) 
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:642px;height:628px;position:relative;">
                    ...
                    <tr style="vertical-align:top;">
                        ...
                        <td></td>
                        <td></td>
                        <td class="csFBB219FE" colspan="3" style="width:76px;height:23px;line-height:21px;text-align:left;vertical-align:top;"><nobr>Client</nobr></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>
                    ...
                    <tr style="vertical-align:top;">
                        ...
                        <td></td>
                        <td class="csA7C33414" colspan="2" style="width:262px;height:35px;line-height:28px;text-align:left;vertical-align:top;"><nobr>FACTURE&nbsp;N&#176;&nbsp;000&nbsp;'.$numFacture.'</nobr></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr style="vertical-align:top;">
                        <td style="width:0px;height:23px;"></td>
                        <td></td>
                        <td class="csFBB219FE" colspan="2" style="width:262px;height:23px;line-height:21px;text-align:left;vertical-align:top;"><nobr>Date&nbsp;:&nbsp;'.$dateVente.'</nobr></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    ';
                        ...
                        <td class="cs36E0C1B8" style="width:113px;height:22px;line-height:16px;text-align:center;vertical-align:middle;"><nobr>'.$TotalVente.'</nobr></td>
                        <td></td>
                    </tr>
                    <tr style="vertical-align:top;">
                    ...
                    <tr style="vertical-align:top;">
                        <td style="width:0px;height:22px;"></td>
                        <td></td>
                        <td class="cs9E712815" colspan="4" style="width:337px;height:22px;line-height:18px;text-align:left;vertical-align:top;"><nobr>Date&nbsp;de&nbsp;r&#233;glement&nbsp;:&nbsp;'.$dateVente.'</nobr></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr style="vertical-align:top;">
                        <td style="width:0px;height:22px;"></td>
                        <td></td>
                        <td class="cs9E712815" colspan="4" style="width:337px;height:22px;line-height:18px;text-align:left;vertical-align:top;"><nobr>Date&nbsp;Ex&#233;cution&nbsp;:&nbsp;'.$dateExecution.'</nobr></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr style="vertical-align:top;">
                        <td style="width:0px;height:22px;"></td>
                        <td></td>
                        <td class="cs9E712815" colspan="4" style="width:337px;height:22px;line-height:18px;text-align:left;vertical-align:top;"><nobr>Ex&#233;cutant&nbsp;:&nbsp;'.$Executant.'</nobr></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
    ...
    {
        $data = vDetailVente::select(['id','refEnteteVente','refProduit','designationProduit','pu','unite','refCategorie','CategorieProduit','puVente','qteVente','PT','author','refClient','dateVente','dateExecution','Executant','noms','contact','mail','refAvenue','refCategieClient','CategorieClient','photo','slug','nomAvenue','idCommune','nomQuartier','idQuartier','idVille','nomCommune','idProvince','nomVille','idPays','nomProvince','nomPays','created_at','TotalVente'])
        ...
        foreach ($data as $row) 
        {
           ...
           <td class="cs6E02D7D2" colspan="3" style="width:65px;height:22px;line-height:16px;text-align:center;vertical-align:middle;"><nobr>'.$row->qteVente.'</nobr></td>
           <td class="cs6E02D7D2" colspan="3" style="width:137px;height:22px;line-height:16px;text-align:center;vertical-align:middle;"><nobr>'.$row->puVente.'</nobr></td>
