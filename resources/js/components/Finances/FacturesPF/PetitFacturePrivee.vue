        ...
        <v-card-text>
          ...
          <table cellpadding="0" cellspacing="0" border="0"
                ...
                <tr style="vertical-align:top;">
                  ...
                  <td class="cs101A94F7" colspan="6" style="width:126px;height:92px;text-align:left;vertical-align:top;">
                    <div style="overflow:hidden;width:126px;height:92px;">
                      ...
                      <!-- <img style="width:126px;height:92px;" :src="
                                                  item.logo === null
                ...
                <tr style="vertical-align:top;">
                  ...
                  <td class="cs38AECAED" colspan="13"
                    style="width:314px;height:22px;line-height:16px;text-align:center;vertical-align:middle;">
                    <nobr>N&#176;&nbsp;Impot&nbsp;:&nbsp;{{ test.numImpot }}</nobr>
                  </td>
                  <td></td>
                  <td></td>
                  <td></td>
                ...
                <tr style="vertical-align:top;" v-for="(donnee, index) in donneesvente" :key="index">
                  <td style="width:0px;height:22px;"></td>
                  <td></td>
                  <td></td>
                  <td></td>
                  ...
                  <td class="cs38AECAED" colspan="3"
                    ...
                    <nobr>{{ donnee.puVente }}FC</nobr>
                  </td>
                  <td class="cs38AECAED" colspan="4"
                    style="width:101px;height:22px;line-height:15px;text-align:center;vertical-align:middle;">
                    <nobr>{{ donnee.PT }}FC</nobr>
                  </td>
                  <!-- <td class="csCE72709D" colspan="5" style="width:91px;height:22px;line-height:15px;text-align:left;vertical-align:middle;"><nobr>{{ item.designationProduit }}</nobr></td>
                    <td class="cs38AECAED" colspan="2" style="width:35px;height:22px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>{{ item.qteVente }}</nobr></td>
                    <td class="cs38AECAED" colspan="3" style="width:78px;height:22px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>{{ item.puVente }}</nobr></td>
                    <td class="cs38AECAED" colspan="4" style="width:101px;height:22px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>{{ item.PT }}</nobr></td> -->
                  <td></td>
                  <td></td>
                </tr>
                <tr style="vertical-align:top;">
                ...
                <tr style="vertical-align:top;">
                  ...
                  <td class="csA2F7C04E" colspan="6"
                    ...
                    <nobr>{{ entete.TotalVente }}FC</nobr>
                  </td>
                  <td></td>
                  <td></td>
                </tr>
                ...
                <tr style="vertical-align:top;">
                  ...
                  <td class="csEF71EB8E" colspan="6"
                    style="width:101px;height:22px;line-height:17px;text-align:left;vertical-align:middle;">
                    <nobr>A&nbsp;Payer&nbsp;(USD)</nobr>
                  </td>
                  <td class="csA2F7C04E" colspan="6"
                    style="width:178px;height:22px;line-height:17px;text-align:center;vertical-align:middle;">
                    <nobr>{{ entete.TotalVenteUSD }}$</nobr>
                  </td>
                  <td></td>
                  <td></td>
                </tr>
...
export default {
  ...
  methods: {
    ...
    testTitle() {
      if (this.edit == true) {
        this.titleComponent = "modification de";
      } else {
    ...
    showModel(id) {
      ...
      this.editOrFetch(`${this.apiBaseURL}/fetch_entreprise_2`).then(
       ({ data }) => {
          if (data) {
            donnees = data.data
          }
      ...
      this.editOrFetch(`${this.apiBaseURL}/fetch_detailfacture_for_entete/${id}`).then(
        ({ data }) => {
          if (data) {
            _donneesvente = data.data
            this.donneesvente = _donneesvente
          }
          console.log('Teste v-for:', _donneesvente);
          _donneesvente.map((item) => {
            this.entete = item
          })
