          ...
          <v-card :loading="loading">
            <v-form ref="form" lazy-validation>
              ...
              <v-card-text>
                  ...
                  <v-text-field type="date" label="Date Cloture" dense prepend-inner-icon="extension" :rules="[(v) => !!v || 'Ce champ est requis']" outlined
    ...
    validate() {
      ...
      if (this.$refs.form.validate()) {
        ...
        if (this.$refs.form.validate()) {
          this.isLoading(true);          
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_cloture_comptabilite`,
