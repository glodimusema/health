    ...
    <v-flex md12>
      ...
      <v-list-item-title style="margin-left: -20px">Maladies Chroniques</v-list-item-title>
                            ...
                            <v-list-item link @click="editDataStatut(item.id)">
                              ...
                              <v-list-item-title style="margin-left: -20px">Autoriser la Consultation</v-list-item-title>
                            </v-list-item>
...
export default {
  ...
  methods: {
    ...
    fetchDataList() {
      ...
      this.fetch_data(`${this.apiBaseURL}/fetch_enteteconsultation_attente?page=`);
    },
