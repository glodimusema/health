                  ...
                  <template v-slot:default>
                    <thead>
                      ...
                      <tr>                        
                        ...
                        <th class="text-left">NuméroBon</th>
                        ...
                        <td>
                          ...
                          <v-menu bottom rounded offset-y transition="scale-transition">
                            ...
                            <v-list dense width="">
                              ...
                              <v-list-item v-if="item.totalPaie == 0 || item.totalPaie == null || (modifier=='OUI')" link @click="editData(item.id)">
                                <v-list-item-icon>
                              ...
                              <v-list-item v-if="item.totalPaie == 0 || item.totalPaie == null || (supprimer=='OUI')" link @click="deleteData(item.id)">
                                <v-list-item-icon>
  ...
  methods: {
    ...
    validate() {
      if (this.$refs.form.validate()) {
        ...
        if (this.edit) {
          ...
          this.svData.author = this.userData.name;
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_entetefacturation`,
            JSON.stringify(this.svData)
          )
            .then(({ data }) => {
              this.showMsg(data.data);
    ...
    showPaieFacturation(refEnteteFacturation, name) {
          ...
          if (refEnteteFacturation != '') {
            ...
            this.$refs.PaiementFacture.getRouteParam();
