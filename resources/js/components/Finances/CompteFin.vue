          ...
          <v-card :loading="loading">
            <v-form ref="form" lazy-validation>
              ...
              <v-card-text>
                ...
                <v-select label="Selectionnez la Classe" prepend-inner-icon="mdi-map" dense
                  :rules="[(v) => !!v || 'Ce champ est requis']" :items="classeList" item-text="nom_classe" item-value="id"
                  outlined v-model="svData.refClasse">
                </v-select>
                
                <v-select label="Selectionnez le Type Compte" prepend-inner-icon="mdi-map" dense
                ...
                <v-select label="Selectionnez la Position" prepend-inner-icon="mdi-map" dense
