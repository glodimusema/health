        ...
        <v-card :loading="loading">
          <v-form ref="form" lazy-validation>
            ...
            <v-card-text>
              ...
              <v-select label="Selectionnez la Provenance" prepend-inner-icon="mdi-map"
              ...
              <v-select label="Selectionnez le Blocs" prepend-inner-icon="mdi-map"
              ...
              <v-text-field label="Cfr. N° Etat de Besoin" prepend-inner-icon="event" dense
...
import Depenses from '../Depenses.vue';
