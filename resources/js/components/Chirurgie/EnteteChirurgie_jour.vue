                    ...
                    <tbody>
                      <tr v-for="item in fetchData" :key="item.id">
                        ...
                        <v-list dense width="">
                          ...
                          <v-list-item link @click="showPoseActeMedecin(item.refEnteteCons,item.noms)">
                                <v-list-item-icon>
                                  <v-icon color="#B72C2C">mdi-medical-bag</v-icon>
                                </v-list-item-icon>
...
export default {
    ...
    methods: {
      ...
      fetchDataList() {
        ...
        this.fetch_data(`${this.apiBaseURL}/fecth_enteteoperation_jour?page=`);
