                      ...
                      <v-layout row wrap>
                        ...
                        <div class="mr-1">
                          <v-autocomplete label="Service de Provanance" prepend-inner-icon="home"
                            ...
                            v-model="svData.refService" chips clearable>
                          </v-autocomplete>
                        </div>
                      </v-flex>
                      ...
                      <td>
                        ...
                        <v-menu bottom rounded offset-y transition="scale-transition">
                          ...
                          <v-list dense width="">
                            ...
                            <!-- <v-list-item link @click="showLaboratoire(item.refDetailConst, item.noms)">
                              <v-list-item-icon>
                                <v-icon color="#B72C2C">mdi-medical-bag</v-icon>
                              </v-list-item-icon>
                              <v-list-item-title style="margin-left: -20px">Envoyer au Laboratoire
...
export default {
  ...
  methods: {
    ...
    fetchDataList() {
      this.fetch_data(`${this.apiBaseURL}/fetch_entete_dialyse_jour?page=`);
    },
