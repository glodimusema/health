<template>
  <v-layout>
    ...
    <CertificatDeces ref="CertificatDeces" />
    <CertificatMedical ref="CertificatMedical" />
    <AptitudePhysique ref="AptitudePhysique" />
    <v-flex md12>
      <v-layout row wrap>
        <v-flex xs12 sm12 md6 lg6>
          <div class="mr-1">
            <router-link :to="'/admin/EnteteAttestation'">Attestation</router-link>                               
          </div>
        </v-flex>
        </v-layout>
      <br /><br />
...
import AptitudePhysique from './AptitudePhysique.vue';
import CertificatDeces from './CertificatDeces.vue';
import CertificatMedical from "./CertificatMedical.vue";
...
// PARTIE DES COMPOSANTS===================================================================   
    ...
    if (refAttestation != '') {
      ...
      this.$refs.CertificatMedical.$data.etatModal = true;
      this.$refs.CertificatMedical.$data.refAttestation = refAttestation;
      this.$refs.CertificatMedical.$data.svData.refAttestation = refAttestation;
      this.$refs.CertificatMedical.fetchDataList();
      this.fetchDataList();
      
      this.$refs.CertificatMedical.$data.titleComponent =
    ...
    if (refAttestation != '') {
      ...
      this.$refs.CertificatDeces.$data.etatModal = true;
      this.$refs.CertificatDeces.$data.refAttestation = refAttestation;
      this.$refs.CertificatDeces.$data.svData.refAttestation = refAttestation;
      this.$refs.CertificatDeces.fetchDataList();
      this.fetchDataList();
      
      this.$refs.CertificatDeces.$data.titleComponent =
