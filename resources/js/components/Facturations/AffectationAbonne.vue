          ...
          <v-form ref="form" lazy-validation>
            ...
            <v-card-text>
              ...
              <v-text-field label="Taux de Prise en Charge (%)" prepend-inner-icon="extension"
                :rules="[(v) => !!v || 'Ce champ est requis']" outlined v-model="svData.tauxcharge"></v-text-field>
      ...
      <v-layout row wrap>
        <v-flex xs12 sm12 md6 lg6>
          <div class="mr-1">
            ...
            <router-link :to="'/admin/affectationabonne/'+this.svData.refMalade">/Prise en Charge</router-link>                                 
          </div>
        </v-flex>
        </v-layout>
...
export default {
  ...
  methods: {
    ...
    fetchDataList() {
      ...
      this.refMalade = id;
      this.fetch_data(`${this.apiBaseURL}/fetch_affectationabone_malade/${this.refMalade}?page=`);
    },
