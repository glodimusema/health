        ...
        <v-dialog v-model="dialog" max-width="400px" persistent>
          <v-card :loading="loading">
            <v-form ref="form" lazy-validation>
              <v-card-title>
                Evolutions Réanimation <v-spacer></v-spacer>
  ...
  export default {
    data() {
      return {
        ...
        loading: false,
        disabled: false,
        //'id','refEnteteRea','description','auther'
        svData: {
          id: '',
    ...
    methods: {
      ...
      fetchDataList() {
        ...
        this.fetch_data(`${this.apiBaseURL}/fetch_evolution_for_enteterea/${this.refEnteteRea}?page=`);
        //
      },
