      ...
      this.editOrFetch(`${this.apiBaseURL}/fetch_single_sortieAgent/${id}`).then(
        ({ data }) => {
          ...
          donnees.map((item) => {
            ...
            this.svData.heureRetourPrevue = item.heureRetourPrevue;
            this.svData.dateSortie = item.dateSortie;
            this.svData.libelleannexe = item.libelleannexe;
            this.svData.viseBRH = item.viseBRH;
            this.svData.heureRetour = item.heureRetour;
