                          ...
                          <v-flex xs12 sm12 md12 lg12>
                            <div class="mr-1">
                              <v-autocomplete label="Selectionnez l'Agent" prepend-inner-icon="mdi-map"
                                ...
                                item-text="noms_medecin" item-value="id" dense outlined v-model="svData.refAffectation"
                                chips clearable>
                              </v-autocomplete>
                            </div>
                          </v-flex>
                              ...
                              <tr v-for="item in fetchData" :key="item.id">
                                ...
                                <td>
                                  ...
                                  <v-list dense width="">
                                    ...
                                    <v-list-item link @click="showDetailPaiementSalaire(item.id, item.noms_medecin,item.refAffectation)">
                                      <v-list-item-icon>
