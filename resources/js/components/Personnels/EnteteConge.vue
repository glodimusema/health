                          ...
                          <v-flex xs12 sm12 md6 lg6>
                            <div class="mr-1">
                              <v-autocomplete label="Selectionnez le Remplacant" prepend-inner-icon="mdi-map"
                                :rules="[(v) => !!v || 'Ce champ est requis']" :items="medecinList"
                                item-text="noms_medecin" item-value="noms_medecin" dense outlined v-model="svData.remplacement"
                                chips clearable>
                              </v-autocomplete>
                            </div>
                          </v-flex>
                          ...
                          <v-flex xs12 sm12 md6 lg6>
                            <div class="mr-1">
                              <v-autocomplete label="Selectionnez le Chef de Service" prepend-inner-icon="mdi-map"
                                :rules="[(v) => !!v || 'Ce champ est requis']" :items="medecinList"
                                item-text="noms_medecin" item-value="noms_medecin" dense outlined v-model="svData.chefService"
                                chips clearable>
                              </v-autocomplete>
                            </div>
                          </v-flex>
                              ...
                              <tr v-for="item in fetchData" :key="item.id">
                                ...
                                <td>
                                  ...
                                  <v-list dense width="">
                                    ...
                                    <v-list-item link @click="showCongeAnnuel(item.id, item.noms_medecin)">
                                      <v-list-item-icon>
                                    ...
                                    <v-list-item link @click="showCongeFamillial(item.id, item.noms_medecin)">
                                      <v-list-item-icon>
                                        <v-icon color="#B72C2C">description</v-icon>
                                      </v-list-item-icon>
                                    ...
                                    <v-list-item link @click="showCongeMaternite(item.id, item.noms_medecin)">
                                      <v-list-item-icon>
                                        <v-icon color="#B72C2C">description</v-icon>
                                      </v-list-item-icon>
                                    ...
                                    <v-list-item link @click="showMaladieConge(item.id, item.noms_medecin)">
                                      <v-list-item-icon>
                                        <v-icon color="#B72C2C">description</v-icon>
                                      </v-list-item-icon>
                                    ...
                                    <v-list-item link @click="showAutresConge(item.id, item.noms_medecin)">
                                      <v-list-item-icon>
                                        <v-icon color="#B72C2C">description</v-icon>
                                      </v-list-item-icon>
