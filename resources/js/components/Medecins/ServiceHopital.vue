<template>
  ...
  export default {
    ...
    //   }, 300),
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_servicehopital?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_servicehopital`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_servicehopital/${id}`).then(
          ({ data }) => {
            var donnees = data.data;
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_servicehopital/${id}`).then(
            ({ data }) => {
