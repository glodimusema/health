                ...
                <v-flex xs12 sm12 md12 lg12>
                  <div class="mr-1">
                    <v-autocomplete label="Selectionnez la Maladie" prepend-inner-icon="home"
                      :rules="[(v) => !!v || 'Ce champ est requis']" :items="this.stataData.MaladieList"
                      item-text="nom_maladie" item-value="id" dense outlined v-model="svData.refmaladie" chips clearable
                      @change="getCategorie(svData.refmaladie)">
                    </v-autocomplete>
                  </div>
                </v-flex>
                <v-text-field readonly label="Catégorie" prepend-inner-icon="extension"
                  :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense
                  v-model="svData.nom_categoriemaladie"></v-text-field>

                <v-textarea label="Description Maladie" prepend-inner-icon="extension"
                  :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense
