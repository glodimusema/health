<template>
  <v-row justify="center" class="scrollable-layout">
          ...
          <div>
            ...
            <v-layout>
              ...
              <v-flex md12>
                ...
                <DossierPients ref="DossierPients" />
                <Annexe_Patient ref="Annexe_Patient" />


                <ConsTranfert ref="ConsTranfert" />
                <ConsRetroinformation ref="ConsRetroinformation" />
                                ...
                                <td>
                                  ...
                                  <v-menu bottom rounded offset-y transition="scale-transition">
                                    ...
                                    <v-list dense width="">
                                      ...
                                      <v-list-item link @click="showDossierPatient(item.id, item.noms)">
                                        <v-list-item-icon>
                                          <v-icon color="#B72C2C">mdi-medical-bag</v-icon>
                                        </v-list-item-icon>
                                        <v-list-item-title style="margin-left: -20px">Dossier Médical
                                        </v-list-item-title>
                                      </v-list-item>
                                      ...
                                      <v-list-item link @click="showPoseActeMedecin(item.id, item.noms)">
                                        ...
                                        <v-list-item-title style="margin-left: -20px">Poser les Actes Medicaux
                                        </v-list-item-title>
                                      </v-list-item>

                                      <v-list-item link @click="showConsTransfert(item.id, item.noms)">
                                        <v-list-item-icon>
                                          <v-icon color="#B72C2C">mdi-medical-bag</v-icon>
                                        </v-list-item-icon>
                                        <v-list-item-title style="margin-left: -20px">Fiche de Transfert
                                        </v-list-item-title>
                                      </v-list-item>

                                      <v-list-item link @click="showConsRetroinformation(item.id, item.noms)">
                                        <v-list-item-icon>
                                          <v-icon color="#B72C2C">mdi-medical-bag</v-icon>
                                        </v-list-item-icon>
                                        <v-list-item-title style="margin-left: -20px">Fiche de Retro-Infromation
                                        </v-list-item-title>
                                      </v-list-item>
...
import ConsRetroinformation from './ConsRetroinformation.vue';
import ConsTranfert from './ConsTranfert.vue';
import DetailOrdonances from './DetailOrdonances.vue';
import DiagnosticDef from './DiagnosticDef.vue';
import DossierPients from './DossierPients.vue';
...
import Annexe_Patient from "./Annexe_Patient.vue";
...
export default {
  ...
  methods: {
    ...
    // fetchListServices
    showDossierPatient(refEnteteCons, name) {

      if (refEnteteCons != '') {

        this.$refs.DossierPients.$data.etatModal = true;
        this.$refs.DossierPients.$data.id = refEnteteCons;
        this.$refs.DossierPients.$data.svData.refEnteteCons = refEnteteCons;
        this.$refs.DossierPients.fetchDataList();
        this.$refs.DossierPients.fetchListSelection();
        this.fetchDataList();

        this.$refs.DossierPients.$data.titleComponent =
          "Dossier Medical pour " + name;
    ...
    insertTestCutanee(id, dateDetailCons) {
      ...
      this.svData.conclusionTest = 'Encours'
      this.svData.clinique = 'Encours'
      this.svData.examinateur = 'Encours'
      this.svData.specialite = 'Encours'
    ...
    fetchDataList() {
      this.fetch_data(`${this.apiBaseURL}/fetch_detail_enteteconsultation/${this.refEnteteCons}?page=`);
    ...
    showConsTransfert(refDetailCons, name) {

      if (refDetailCons != '') {

        this.$refs.ConsTranfert.$data.etatModal = true;
        this.$refs.ConsTranfert.$data.refDetailCons = refDetailCons;
        this.$refs.ConsTranfert.$data.svData.refDetailCons = refDetailCons;
        this.$refs.ConsTranfert.fetchDataList();
        this.$refs.ConsTranfert.fetchListSelection();
        this.fetchDataList();

        this.$refs.ConsTranfert.$data.titleComponent =
          "La fiche de transfert pour " + name;
    ...
    showConsRetroinformation(refDetailCons, name) {

      if (refDetailCons != '') {

        this.$refs.ConsRetroinformation.$data.etatModal = true;
        this.$refs.ConsRetroinformation.$data.refDetailCons = refDetailCons;
        this.$refs.ConsRetroinformation.$data.svData.refDetailCons = refDetailCons;
        this.$refs.ConsRetroinformation.fetchDataList();
        this.$refs.ConsRetroinformation.fetchListSelection();
        this.fetchDataList();

        this.$refs.ConsRetroinformation.$data.titleComponent =
          "Fiche de Retro-Infromation pour " + name;
...
<style>
.scrollable-layout {
  max-height: 300px; /* Set the maximum height for the layout */
