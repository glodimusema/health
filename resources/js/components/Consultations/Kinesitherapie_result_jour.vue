    ...
    <v-layout>
      ...
      <v-flex md12>
            ...
            <v-form ref="form" lazy-validation>
              ...
              <v-card-text>
                ...
                <v-text-field type="number" label="Nomnbre de Seance" prepend-inner-icon="extension"
                  ...
                  <v-textarea label="Commentaire après les Séances " prepend-inner-icon="extension"
                  :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense
                  v-model="svData.commentaire"></v-textarea>
        ...
        <v-flex xs12 sm12 md6 lg6>
          <div class="mr-1">
            <router-link :to="'/admin/Kinesitherapie_result'">Kinesitherapie/Kinesitherapie</router-link>                               
          </div>
        </v-flex>
        </v-layout>
...
export default {
  ...
  methods: {
    ...
    validate() {
      if (this.$refs.form.validate()) {
        ...
        if (this.edit) {          
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/update_kinesiterapie_result/${this.svData.id}`,
    ...
    fetchDataList() {     
      this.fetch_data(`${this.apiBaseURL}/fecth_kine_valide_jour?page=`);
      //
    },
