<template>
  ...
  export default {
    ...
    methods: {
      ...
      // ,
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/ad1/fetch_commune?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/ad1/insert_commune`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/ad1/fetch_single_commune/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/ad1/delete_commune/${id}`).then(
            ({ data }) => {
