<template>
              ...
              <v-form ref="form" lazy-validation>
                ...
                <v-card-text>
                  <v-text-field
                    ...
                    outlined
                    v-model="svData.nom_categoriemedicament"
                  ></v-text-field>
                </v-card-text>
                <v-card-actions>
                  <v-spacer></v-spacer>
  ...
  export default {
    ...
    methods: {
      ...
      showModal() {
        this.dialog = true;
        this.titleComponent = "Ajout Categorie Medicament";
        this.edit = false;
  ...
  //
      testTitle() {
        if (this.edit == true) {
          this.titleComponent = "modification de " + item.nom_categoriemedicament;
        } else {
          this.titleComponent = "Ajout Categorie Medicament";
        }
      }
      ,
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_categoriemedicament?page=`);
      },
      fetchAccess() {
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_categoriemedicament`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_categoriemedicament/${id}`).then(
          ({ data }) => {
            var donnees = data.data;
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_categoriemedicament/${id}`).then(
            ({ data }) => {
