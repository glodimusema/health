<template>
            ...
            <v-card :loading="loading">
              <v-form ref="form" lazy-validation>
                ...
                <v-card-text>
                  ...
                  <v-text-field type="number" label="Prix " prepend-inner-icon="mdi-bank" dense
  ...
  export default {
    ...
    methods: {
      ...
      showModal() {
        this.dialog = true;
        this.titleComponent = "Ajout Catégorie Souscription";
        this.edit = false;
    ...
    //   }, 300),
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/a1/fetch_categoriesous?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/a1/insert_categoriesous`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/a1/fetch_single_categoriesous/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/a1/delete_categoriesous/${id}`).then(
            ({ data }) => {
