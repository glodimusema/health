...
export default {
  ...
  methods: {
    ...
    showModal() {
      this.dialog = true;
      this.titleComponent = "Ajout Periode Peni";
      this.edit = false;
    ...
    ,
    onPageChange() {
      this.fetch_data(`${this.apiBaseURL}/fetch_periode_Peni?page=`);
    },
    ...
    validate() {
      if (this.$refs.form.validate()) {
        ...
        this.insertOrUpdate(
          `${this.apiBaseURL}/insert_periode_Peni`,
    ...
    editData(id) {
      this.editOrFetch(`${this.apiBaseURL}/fetch_single_periode_Peni/${id}`).then(
        ({ data }) => {
          var donnees = data.data;
    ...
    clearP(id) {
      this.confirmMsg().then(({ res }) => {
        this.delGlobal(`${this.apiBaseURL}/delete_periode_Peni/${id}`).then(
          ({ data }) => {
