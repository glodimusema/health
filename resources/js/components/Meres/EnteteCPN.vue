              ...
              <v-dialog v-model="dialog" max-width="900px" persistent>
                <v-card :loading="loading">
                  <v-form ref="form" lazy-validation>
                    <v-card-title>
                      Consultation Presnatale <v-spacer></v-spacer>
                      ...
                      <v-layout row wrap>
                        ...
                        <div class="mr-1">
                            <v-select label="Primipare de 19 ans ou moins" :items="[
                              ...
                              item-value="designation" v-model="svData.primipare"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="35 ans ou plus" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.plus_35"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="TBC" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.tbc"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="HTA" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.hta"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="SCA/SS" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.sca"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="DBT" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.dbt"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="CAR" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.car"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="MGF" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.mef"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="RAA" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.raa"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="SYPHYLIS" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.syphylis"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="VIH/SIDA" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.vIH_sida"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="VVS" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.vvS"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="PEP" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.pEP"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="Césarienne" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.cesarienne"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Cerciage" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.cerciage"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="Fibrome utérin" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.fibrame"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Fracture bassin" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.fature_bassin"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="GEU" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.gEU"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Fistule" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.fistule"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="Utérus Cicatriciel" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.uterus_cicotricile"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Traitement pour stérilité" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.traitement_sterilite"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="Prématuré" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.premature"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Post-maturé" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.poste_mature"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-select label="Mort-né" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.mort_ne"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Mort avant 7 jours" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.mort_avant_7j"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-text-field type="date" label="Dernier accouchement date" prepend-inner-icon="event" dense
                        ...
                        <div class="mr-1">
                            <v-select label="Intervalle < 2 ans" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.interval2ans"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Complications post-partum (Oui)" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.compl_post_oui"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Complications post-partum (Non)" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.complication_post_non"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Malnutrition sévère oui sans appétit" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.malnutrition"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Goitre" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.goitre"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Conjonctives ictériques" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.conjoctivesIcterifars"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="TA systolique > 140" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.TA_systolique"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="TA diastolique > 90" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.TA_diastolique1"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="TA diastolique > 90" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.TA_diastolique2"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="et ++ protéunirie" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.proteine"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Discordance HU avec l'age de grossesse" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.discondance"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Mouvements foetaux négatifs à partir de la 36e semaines de grossesse" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.mouvementFoctaux"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Présentation transversale (a partir de la 36e semaines de la grossesse)" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.pres_transversale"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Bassin rétréci" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.bassin_aetreci"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Masse suspecte de sein" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.masse_supecte"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                        ...
                        <div class="mr-1">
                            <v-select label="Drépanocytose" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.drepanocytose"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                        ...
                        <div class="mr-1">
                            <v-select label="Dort sous MII Oui" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.dors_mil_oui"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Si non, donner MII" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.donner_MII"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Supplementation Fer-Acide folique-avant accouchement" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.fer_acide"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Après accouchement" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.apres_Accouchement"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Vermifuge:Mebendazole au 2e trim." :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.vermifuge"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="RPR" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.Rpr"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="RPR positif oui" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.rPR_positif_oui"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                        ...
                        <div class="mr-1">
                            <v-select label="Conseils PF" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.conseilsPF"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                        ...
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-text-field type="date" label="DCIP : la femme - date conseil" prepend-inner-icon="event" dense
                        ...
                        <div class="mr-1">
                            <v-select label="Code PTME" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.pTME"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Résultat Test" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.resultat_test1"></v-select>
                          </div>
                        </v-flex>
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-text-field type="date" label="Date Annonce" prepend-inner-icon="event" dense
                        ...
                        <v-flex xs12 sm12 md6 lg6>
                          <div class="mr-1">
                            <v-text-field type="date" label="Partenaire - date conseil" prepend-inner-icon="event" dense
                        ...
                        <div class="mr-1">
                            <v-select label="Résultats Test" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.resultat_test2"></v-select>
                          </div>
                        </v-flex>
                        ...
                        <div class="mr-1">
                            <v-select label="Plan d'accouchement discuté" :items="[
                              ...
                              :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense item-text="designation"
                              item-value="designation" v-model="svData.plau_accouchement"></v-select>
                          </div>
                        </v-flex>
...
import VaccinationMere from './VaccinationMere.vue';
  ...
  export default {
    ...
    methods: {
      ...
      fetchDataList() {
        this.fetch_data(`${this.apiBaseURL}/fetch_CPN_for_cons/${this.refDetailConst}?page=`);
