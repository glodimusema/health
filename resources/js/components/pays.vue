<template>
  ...
  export default {
    ...
    //   }, 300),
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/ad1/fetch_pays?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/ad1/insert_pays`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/ad1/fetch_single_pays/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/ad1/delete_pays/${id}`).then(
            ({ data }) => {
