            ...
            <v-form ref="form" lazy-validation>
              ...
              <v-card-text>
                ...
                <v-layout row wrap>
                  ...
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-text-field label="Poids à la Naissance" prepend-inner-icon="event" dense
                  ...
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-text-field label="Taille à a la Naissance" prepend-inner-icon="event" dense
                  ...
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Est né à Domicile" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.Estnedomicile"></v-select>
                    </div>
                  </v-flex>
                  ...
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Orphelin de Mère" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.OrphelinMere"></v-select>
                    </div>
                  </v-flex>
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Orphelin de Père" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.OrphelinPere"></v-select>
                    </div>
                  </v-flex>
                  ...
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Frère ou soeur malnourri" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.FrereSoeur"></v-select>
                    </div>
                  </v-flex>
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="La mère a plus de 5 enfants vivants" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.Mere5Enfants"></v-select>
                    </div>
                  </v-flex>
                  ...
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="L'enfant est un jumeau" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.EnfantJumeau"></v-select>
                    </div>
                  </v-flex>
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Naissances rapprochées" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.NaissanceRapproche"></v-select>
                    </div>
                  </v-flex>
                  ...
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="La mère a moins de 18 ans" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.Mere18ans"></v-select>
                    </div>
                  </v-flex>
                  ...
                  <v-flex xs12 sm12 md12 lg12>
                    <div class="mr-1">
                      <v-select label="Névaripine co si mère PVV" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.Nevaripine"></v-select>
                    </div>
                  </v-flex>
                  ...
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Mort né" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.Mortne"></v-select>
                    </div>
                  </v-flex>
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Mort avant 24h" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.Mort24h"></v-select>
                    </div>
                  </v-flex>
                  ...
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Vit. A à la mère" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.VitamineMere"></v-select>
                    </div>
                  </v-flex>
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Fer à la mère" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.FerMere"></v-select>
                    </div>
                  </v-flex>
                  ...
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Type Accouchement" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.TypeAccouchement"></v-select>
                    </div>
                  </v-flex>
                  <v-flex xs12 sm12 md6 lg6>
                    <div class="mr-1">
                      <v-select label="Acouchements hors FOSA" :items="[
                        ...
                        item-text="designation" item-value="designation" v-model="svData.AccouchementFOSA"></v-select>
                    </div>
                  </v-flex>
...
export default {
  ...
  methods: {
    ...
    fetchDataList() {
      this.fetch_data(`${this.apiBaseURL}/fetch_enteteVaccin?page=`);
