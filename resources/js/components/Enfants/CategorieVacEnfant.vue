...
export default {
  ...
  methods: {
    ...
    ,
    onPageChange() {
      this.fetch_data(`${this.apiBaseURL}/fetch_categorieEf?page=`);
    },
      fetchAccess() {
    ...
    validate() {
      if (this.$refs.form.validate()) {
        ...
        this.insertOrUpdate(
          `${this.apiBaseURL}/insert_categorieEf`,
    ...
    editData(id) {
      this.editOrFetch(`${this.apiBaseURL}/fetch_single_categorieEfe/${id}`).then(
        ({ data }) => {
          var donnees = data.data;
    ...
    clearP(id) {
      this.confirmMsg().then(({ res }) => {
        this.delGlobal(`${this.apiBaseURL}/delete_categorieEf/${id}`).then(
          ({ data }) => {
