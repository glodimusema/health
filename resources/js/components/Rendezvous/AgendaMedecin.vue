                    ...
                    <v-form ref="form" lazy-validation>
                      ...
                      <v-card-text>
                        ...
                        <v-flex xs12 sm12 md12 lg12>
                          <div class="mr-1">
                            <v-text-field label="Noms du Patient" prepend-inner-icon="extension" dense :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                        ...
                        <v-flex xs12 sm12 md12 lg12>
                          <div class="mr-1">
                            <v-text-field label="Contact du Patient" prepend-inner-icon="extension" dense :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                              v-model="svData.contact"></v-text-field>
                          </div>
                        </v-flex>
                        
                        <v-flex xs12 sm12 md12 lg12>
                        <div class="mr-1">
                          <v-text-field type="date" label="Date Rendez-vous" prepend-inner-icon="extension"  dense :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                      ...
                      <v-flex xs12 sm12 md12 lg12>
                          <div class="mr-1">
                            <v-text-field label="Lieu Rendez-vous" prepend-inner-icon="extension" dense :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                              ...
                              <v-menu bottom rounded offset-y transition="scale-transition">
                                ...
                                <v-list dense width="">
                                  ...
                                  <v-list-item link @click="printBill(item.id)">
                                    ...
                                    <v-list-item-title style="margin-left: -20px">Imprimer Bon</v-list-item-title>
                                  </v-list-item>                       
  ...
  export default {
    ...
    methods: {
      ...
      fetchDataList() {
        ...
        this.svData.refUser = id;
        this.fetch_data(`${this.apiBaseURL}/fetch_agenda_for_medecin/${this.svData.refUser}?page=`);
