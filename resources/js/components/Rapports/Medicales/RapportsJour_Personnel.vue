                    ...
                    <v-flex md7>
                        ...
                        <v-row v-show="showDate">
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="showPaiementPersonnelByDate" block color="#B72C2C" dark>
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="showPaiementPersonnel_ServiceByDate" block color="#B72C2C" dark>
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="showPaiementPersonnel_MoisByDate" block color="#B72C2C" dark>
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="showPaiementPersonnel_MoisRubriqueByDate" block color="#B72C2C" dark>
