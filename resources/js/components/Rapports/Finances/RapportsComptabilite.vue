                    ...
                    <v-flex md7>
                        ...
                        <v-row v-show="showDate">
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="show_fetch_livre_caisse" block color="#B72C2C" dark>
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="show_fetch_livre_banque" block color="#B72C2C" dark>
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="show_fetch_rapport_bilan" block color="#B72C2C" dark>
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="show_fetch_rapport_journal_caisse" block color="#B72C2C" dark>
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="show_fetch_rapport_detailfacture_date_compte_cash" block color="#B72C2C" dark>
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="show_fetch_rapport_detailfacture_date_compte_credit" block color="#B72C2C" dark>
