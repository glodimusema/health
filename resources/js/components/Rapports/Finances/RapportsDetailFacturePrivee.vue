                    ...
                    <v-flex md7>
                        ...
                        <v-row v-show="showDate">
                                ...
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="showDetailFactureByDate" block color="#B72C2C" dark>
                                            <v-icon>print</v-icon> RAPPORT DES FACTURATIONS(DETAIL)
                                        </v-btn>
                                    </span>
                                </template>
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="showDetailFactureByDate_Excel" block color="#B72C2C" dark>
                                            <v-icon>print</v-icon> RAPPORT DES FACTURATIONS(DETAIL) EXCEL
                                        </v-btn>
                                    </span>
                                </template>
                                <span>Imprimer le rapport</span>
                                ...
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="showDetailFactureByDate_Medecin" block color="#B72C2C" dark>
                                            <v-icon>print</v-icon> FACTURATIONS(DETAIL)/MEDECIN
                                        </v-btn>
                                    </span>
                                </template>
                                <span>Imprimer le rapport</span>
                                ...
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="showDetailFactureByDate_Medecin_Service" block color="#B72C2C" dark>
                                            <v-icon>print</v-icon> FACTURATIONS(DETAIL)/MEDECIN-SERVICE
                                        </v-btn>
                                    </span>
                                </template>
                                <span>Imprimer le rapport</span>
                            ...
                            <v-tooltip bottom color="black">
                                <template v-slot:activator="{ on, attrs }">
                                    <span v-bind="attrs" v-on="on">
                                        <v-btn @click="showDetailFacture_ByDate_Caissier" block color="#B72C2C" dark>
                                            <v-icon>print</v-icon> FACTURATIONS(DETAILS)/CAISSIER
                                        </v-btn>
                                    </span>
                                </template>
                                <span>Imprimer le rapport</span>
     ...
     //fultrage de donnees
      async Get_unite_for_Departement(idDepartement) {
        ...
        showDetailFactureByDate() {
            ...
            if (date1 <= date2) {
                window.open(`${this.apiBaseURL}/fetch_rapport_detailfactureprivee_date?date1=` + date1+"&date2="+date2);           
        ...
        showDetailFactureByDate_Excel() {
            var date1 =  this.dates[0] ;
            var date2 =  this.dates[1] ;
            if (date1 <= date2) {
                window.open(`${this.baseURL}/ShowdetailfacturationPriveeExcel?date1=` + date1+"&date2="+date2);           
        ...
        showDetailFactureByDate_Medecin() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_detailfactureprivee_date_medecin?date1=` + date1+"&date2="+date2+"&refMedecin="+this.svData.refMedecin);
                }else
                {
        ...
        showDetailFactureByDate_Departement() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_detailfactureprivee_date_departement?date1=` + date1+"&date2="+date2+"&refDepartement="+this.svData.refDepartement);
                }
                else
                {
        ...
        showDetailFactureByDate_Service() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_detailfactureprivee_date_service?date1=` + date1+"&date2="+date2+"&refUniteProduction="+this.svData.refUniteProduction);
                }
                else
                {
        ...
        showDetailFacture_ByDate_Caissier() {
            var date1 =  this.dates[0] ;
            var date2 =  this.dates[1] ;
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_detailfactureprivee_date_caissier?date1=` + date1+"&date2="+date2+"&author="+this.svData.author);
                }else
                {
        ...
        showDetailFactureByDate_Medecin_Service() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_detailfactureprivee_date_medecin_service?date1=` + date1+"&date2="+date2+"&refMedecin="+this.svData.refMedecin+"&refUniteProduction="+this.svData.refUniteProduction);
                }
                else
                {
