      ...
      async Get_unite_for_Departement(idDepartement) {
        ...
        showDetailFactureByDate_Banque() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_paiementfacture_date_banque?date1=` + date1+"&date2="+date2+"&refBanque="+this.svData.refBanque);
                }else
                {
        ...
        showDetailFactureByDate_Caissier() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_paiementfacture_date_caissier?date1=` + date1+"&date2="+date2+"&author="+this.svData.author);
                }else
                {
        ...
        showDetailFactureByDate_Departement() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_paiementfacture_date_departement?date1=` + date1+"&date2="+date2+"&refDepartement="+this.svData.refDepartement);
                }
                else
                {
        ...
        showDetailFactureByDate_Service() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_paiementfacture_date_service?date1=` + date1+"&date2="+date2+"&refUniteProduction="+this.svData.refUniteProduction);
                }
                else
                {
        ...
        showDetailFactureByDate_Banque_Service() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_paiementfacture_date_banque_service?date1=` + date1+"&date2="+date2+"&refBanque="+this.svData.refBanque+"&refUniteProduction="+this.svData.refUniteProduction);
                }
                else
                {
