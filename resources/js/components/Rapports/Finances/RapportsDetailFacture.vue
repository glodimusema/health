      ...
      async Get_unite_for_Departement(idDepartement) {
        ...
        showDetailFactureByDate_Medecin() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_detailfacture_date_medecin?date1=` + date1+"&date2="+date2+"&refMedecin="+this.svData.refMedecin);
                }else
                {
        ...
        showDetailFacture_ByDate_Caissier() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_detailfacture_date_caissier?date1=` + date1+"&date2="+date2+"&author="+this.svData.author);
                }else
                {
        ...
        showDetailFactureByDate_Medecin_Service() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_detailfacture_date_medecin_service?date1=` + date1+"&date2="+date2+"&refMedecin="+this.svData.refMedecin+"&refUniteProduction="+this.svData.refUniteProduction);
                }
                else
                {
