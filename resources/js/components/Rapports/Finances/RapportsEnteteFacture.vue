...
//
        ...
        showEnteteFacture_ByDate_Caissier() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_entetefacture_date_caissier?date1=` + date1+"&date2="+date2+"&author="+this.svData.author);
                }else
                {
        ...
        showEnteteFacture_Credit_ByDate_Caissier() {
            ...
            if (date1 <= date2) {
                ...
                if(this.svData.author!="")
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_entetefacture_credit_date_caissier?date1=` + date1+"&date2="+date2+"&author="+this.svData.author);
                }else
                {
                    this.showError("Veillez selectionner le caissier svp");
                }               
        ...
        showEnteteFacture_Cash_ByDate_Caissier() {
            ...
            if (date1 <= date2) {
                ...
                if(this.svData.author!="")
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_entetefacture_Cash_date_caissier?date1=` + date1+"&date2="+date2+"&author="+this.svData.author);
                }else
                {
                    this.showError("Veillez selectionner le caissier svp");
                }               
        ...
        showDetailFactureByDate_Medecin() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_entetefacture_date_medecin?date1=` + date1+"&date2="+date2+"&refMedecin="+this.svData.refMedecin);
                }else
                {
        ...
        showDetailFactureByDate_Medecin_Service() {
            ...
            if (date1 <= date2) {
                ...
                {
                    window.open(`${this.apiBaseURL}/fetch_rapport_entetefacture_date_medecin_service?date1=` + date1+"&date2="+date2+"&refMedecin="+this.svData.refMedecin+"&refUniteProduction="+this.svData.refUniteProduction);
                }
                else
                {
