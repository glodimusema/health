<template>
  ...
  export default {
    ...
    methods: {
      ...
      ,
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_natureechantillon?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_natureechantillon`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_natureechantillon/${id}`).then(
          ({ data }) => {
            var donnees = data.data;
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_natureechantillon/${id}`).then(
            ({ data }) => {
