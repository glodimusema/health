<template>
  ...
  export default {
    ...
    methods: {
      ...
      showModal() {
        this.dialog = true;
        this.titleComponent = "Ajout Methode Examen";
        this.edit = false;
      ...
      testTitle() {
        if (this.edit == true) {
          ...
          this.titleComponent = "Ajout Echantillon";
        }
      }
      ,
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_methodeexamen?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_methodeexamen`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_methodeexamen/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_methodeexamen/${id}`).then(
            ({ data }) => {
