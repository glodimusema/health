...
export default {
  ...
  methods: {
    ...
    fetchDataList() {
      //fetch_valide_prelevement
      //this.fetch_data(`${this.apiBaseURL}/fetch_valide_labo?page=`);
    ...
    showLaboratoire(refEntetePrelevement, name, serviceProvenance) {
      ...
      if (refEntetePrelevement != '') {
        ...
        this.$refs.EnteteLabo_Resultat.get_methode_Examen();
        this.$refs.EnteteLabo_Resultat.get_nature_Echantillon();  
