      ...
      <v-layout
          ...
          <v-flex md3 lg3 xs12 class="mb-2">
              ...
              >
                  ...
                  <v-list-item three-line router to="/admin/conf_remise"> 
                  <v-list-item-content>
                      <div class="text-overline mb-4">Total Malades</div>
                      <v-list-item-title class="text-h5 mb-1">
                          {{svData.NombreMaladeTotal}}
                      </v-list-item-title>
          ...
          <v-flex md3 lg3 xs12 class="mb-2">
              ...
              >
                  <!-- card commence -->
                  <v-list-item three-line router to="/admin/agent">
                  <v-list-item-content>
                      <div class="text-overline mb-4">Consultations</div>
                      <v-list-item-title class="text-h5 mb-1">
                       {{svData.NombreConsultation}} 
                      </v-list-item-title>
          ...
          <v-flex md3 lg3 xs12 class="mb-2">
              ...
              >
                  ...
                  <v-list-item-content>
                      <div class="text-overline mb-4">Ordonances</div>
                      <v-list-item-title class="text-h5 mb-1">
                       {{svData.NombreOrdonance}}  
                      </v-list-item-title>
                      <v-list-item-subtitle
                      >Dans le système </v-list-item-subtitle
                      >
           ...
           <v-flex md3 lg3 xs12 class="mb-2">
              ...
              >
                  ...
                  <v-list-item-content>
                      <div class="text-overline mb-4">Medecins</div>
                      <v-list-item-title class="text-h5 mb-1">
                      {{svData.NombreMedecin}}
                      </v-list-item-title>
                      <v-list-item-subtitle
                      >Dans le système</v-list-item-subtitle
                      >
          ...
          <v-layout row wrap>
              <v-flex md6 xs12 sm12  lg6 class="mb-0">
                  <v-container>
                      <stat_ordonance_genre v-bind:typechart="stat.typechart2" />
...
import ListeCeo from "./Dash/ListeCeo.vue";

import dashEntreprise from './Dash/dashEntreprise.vue'
import SexeDashCeo from "./Dash/sexeDashCeo.vue";
import StatMontantEntrantYeba from './Dash/statMontantEntrantYeba.vue'
import stat_ordonance_genre from "./Dash/stat_ordonance_genre.vue";
import statBlog from './Dash/statBlog.vue';
