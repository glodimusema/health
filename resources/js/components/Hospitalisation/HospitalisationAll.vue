...
export default {
  ...
  methods: {
    ...
    fetchDataList() {
      ...
      this.fetch_data(`${this.apiBaseURL}/fetch_hospitalisation?page=`);
    ...
    showSurveillanceHospi(refHospi, name) {
      ...
      if (refHospi != '') {
        ...
        this.$refs.Hospi_SurveillanceHospi.$data.titleComponent =
