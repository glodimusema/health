<template>
              ...
              <v-form ref="form" lazy-validation>
                ...
                <v-card-text>
                  <v-text-field
                    ...
                    outlined dense
                    v-model="svData.nom_servicesoin"
                  ></v-text-field>
  ...
  export default {
    ...
    methods: {
      ...
      showModal() {
        this.dialog = true;
        this.titleComponent = "Ajout Service Soin";
        this.edit = false;
      ...
      testTitle() {
        if (this.edit == true) {
          this.titleComponent = "modification de " + item.nom_servicesoin;
        } else {
      ...
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_servicesoin?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_servicesoin`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_servicesoin/${id}`).then(
          ({ data }) => {
            var donnees = data.data;
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_servicesoin/${id}`).then(
            ({ data }) => {
