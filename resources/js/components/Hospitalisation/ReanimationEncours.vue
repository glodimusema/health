  ...
  <div>
    ...
    <v-layout>
      ...
      <v-flex md12>
        ...
        <Hospi_SurveillanceRea ref="Hospi_SurveillanceRea" />
                        ...
                        <td>
                          ...
                          <v-menu bottom rounded offset-y transition="scale-transition">
                            ...
                            <v-list dense width="">
                              ...
                              <v-list-item link @click="showProfileModalclient(item.refMalade, item.noms)">
                                <v-list-item-icon>
                              ...
                              <v-list-item link @click="showSortieHospitalisation(item.id, item.noms)">
                                ...
                                <v-list-item-title style="margin-left: -20px">Sortie en Réanimation
                                </v-list-item-title>
                              </v-list-item>
                              ...
                              <v-list-item link @click="showSurveillanceRea(item.id, item.noms)">
                                <v-list-item-icon>
                                  <v-icon color="#B72C2C">mdi-medical-bag</v-icon>
                                </v-list-item-icon>
                                <v-list-item-title style="margin-left: -20px">Surveillance en Réanimation
                                </v-list-item-title>
                              </v-list-item>
...
import Hospi_SurveillanceRea from './Hospi_SurveillanceRea.vue';
...
export default {
  ...
  methods: {
    ...
    fetchDataList() {
      ...
      this.fetch_data(`${this.apiBaseURL}/fetch_reanimation?page=`);
    ...
    showTraitementHospi(refHospi, name) {
      ...
      if (refHospi != '') {
        ...
        // this.$refs.Hospi_Traitement.fetchListSelection();
        this.fetchDataList();
    ...
    showSurveillanceRea(refEnteteRea, name) {
      // 

      if (refEnteteRea != '') {

        this.$refs.Hospi_SurveillanceRea.$data.etatModal = true;
        this.$refs.Hospi_SurveillanceRea.$data.refEnteteRea = refEnteteRea;
        this.$refs.Hospi_SurveillanceRea.$data.svData.refEnteteRea = refEnteteRea;
        this.$refs.Hospi_SurveillanceRea.fetchDataList();
        this.fetchDataList();

        this.$refs.Hospi_SurveillanceRea.$data.titleComponent =
          "Surveillance en Reanimation pour " + name;
