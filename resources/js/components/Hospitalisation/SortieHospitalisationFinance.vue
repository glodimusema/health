                          ...
                          <tbody>
                            <tr v-for="item in fetchData" :key="item.id">
                              ...
                              <v-list dense width="">
                                ...
                                <!-- <v-list-item link router :to="'/admin/DetailSortieHospi/'+item.id">
                                  <v-list-item-icon>
                                    <v-icon>mdi-anchor</v-icon>
                                  </v-list-item-icon>
                                  <v-list-item-title style="margin-left: -20px">Services Beneficiés par le Malade
                                  </v-list-item-title>
                                </v-list-item> -->
...
//  //'id','refHospitaliser','dateSortie','diagnosticSortie','autreDetails','author'
  ...
  methods: {
    ...
    fetchDataList() {
     this.fetch_data(`${this.apiBaseURL}/fetch_sortiehospitaliser?page=`);
      // 
    },
