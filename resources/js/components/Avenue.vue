<template>
  ...
  export default {
    ...
    methods: {
      ...
      // ,
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/ad1/fetch_avenue?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/ad1/insert_avenue`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/ad1/fetch_single_avenue/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/ad1/delete_avenue/${id}`).then(
            ({ data }) => {
