                                                ...
                                                <v-menu bottom rounded offset-y transition="scale-transition">
                                                    ...
                                                    <v-list dense width="">
                                                        <v-list-item link
                                                            ...
                                                            <v-list-item-title style="margin-left: -20px">Detail de
                                                                l'client</v-list-item-title>
                                                        </v-list-item>
                                                        ...
                                                        <v-list-item link
                                                            router :to="'/admin/entete_vente/'+item.id">
                                                            <v-list-item-icon>
                                                                <v-icon>mdi-cart-outline</v-icon>
                                                            </v-list-item-icon>
                                                            <v-list-item-title style="margin-left: -20px">Ventes
                                                            </v-list-item-title>
                                                        </v-list-item>
                                                        <v-list-item link
                                                            router :to="'/admin/entete_sous/'+item.id">
                                                            <v-list-item-icon>
                                                                <v-icon>mdi-transit-transfer</v-icon>
                                                            </v-list-item-icon>
                                                            <v-list-item-title style="margin-left: -20px">Souscriptions
                                                            </v-list-item-title>
                                                        </v-list-item>
