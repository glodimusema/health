...
export default {
  ...
  methods: {
    ...
    onPageChange() {
      this.fetch_data(`${this.apiBaseURL}/ad1/fetch_province?page=`);
    },
    fetchListSelection() {
        this.editOrFetch(`${this.apiBaseURL}/ad1/fetch_pays`).then(
          ({ data }) => {
            var donnees = data.data;
            this.payssList = donnees;
    ...
    validate() {
      if (this.$refs.form.validate()) {
        ...
        this.insertOrUpdate(
          `${this.apiBaseURL}/ad1/insert_province`,
    ...
    editData(id) {
      this.editOrFetch(`${this.apiBaseURL}/ad1/fetch_single_province/${id}`).then(
        ({ data }) => {
          var donnees = data.data;
    ...
    clearP(id) {
      this.confirmMsg().then(({ res }) => {
        this.delGlobal(`${this.apiBaseURL}/ad1/delete_province/${id}`).then(
          ({ data }) => {
